...
import { RoadsAndLabels, WeatherRadar, NauticalChartsLayer, TrackHistoryLayer } from "orion-components/Map/Layers";
...
const MapBaseMapboxGL = memo(
	(props) => {
		const { setMapReference, zoom, center, minZoom, maxZoom, WavCamOpen, baseMaps, style, setMapPosition } = props;
