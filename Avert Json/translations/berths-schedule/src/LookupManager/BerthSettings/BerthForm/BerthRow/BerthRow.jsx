...
const propTypes = {
	addBerth: PropTypes.func.isRequired,
	berth: PropTypes.object.isRequired,
	deleteBerth: PropTypes.func.isRequired,
	groupId: PropTypes.string.isRequired,
	removeBerth: PropTypes.func.isRequired,
	saved: PropTypes.bool.isRequired,
	updateBerth: PropTypes.func.isRequired,
		...
		<React.Fragment>
			{canManage ? (
				<TableRow key={id}>
					...
					{validBerth() && (
						<TableCell style={{ border: "unset", paddingRight: 0, paddingLeft: 0 }}>
							<Button
								onClick={handleSave}
								color="primary"
