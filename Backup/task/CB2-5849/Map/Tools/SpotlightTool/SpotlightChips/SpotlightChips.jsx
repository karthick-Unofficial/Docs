...
const SpotlightChips = () => {
	...
	const user = useSelector((state) => state.session?.user.profile, shallowEqual);
	const cameras = useSelector((state) => feedEntitiesWithGeoByTypeSelector("camera")(state), shallowEqual);
