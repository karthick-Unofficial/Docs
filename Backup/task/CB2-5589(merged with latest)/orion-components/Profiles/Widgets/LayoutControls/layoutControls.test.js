...
var _LayoutControls = _interopRequireDefault(require("./LayoutControls"));
...
describe("LayoutControls", function () {
  beforeEach(function () {
  ...
  it("renders", function () {
    var wrapper = (0, _enzyme.shallow)( /*#__PURE__*/_react["default"].createElement(_LayoutControls["default"], {
      open: true,
