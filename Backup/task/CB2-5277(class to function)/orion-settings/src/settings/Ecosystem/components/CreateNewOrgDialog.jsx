...
const handleSubmit = async (values, stagedFile, createNewOrg, updateDisplayErrors) => {
	...
	createNewOrg(organization, stagedFile, user);
};
	...
	return (
		<Dialog
			...
			confirm={{
				...
				action: () => {
					updateDisplayErrors({});
					handleSubmit(values, stagedFile, createNewOrg, updateDisplayErrors);
				}
			}}
		>
			<Fragment>
