...
<div>
	...
	>
		{this.props.triggers.map((trigger) => {
			...
			>
				<Tab
					label={trigger === "cross" ? <Translate value="createEditRule.trigger.anyLine"/> : this.props.displayName === "polygon" || "system" ? <Translate value={`createEditRule.trigger.anyDots.${this.props.displayName}`}/> : <Translate value="createEditRule.trigger.anyDynamic" count={this.props.displayName}/>}
				...
				<Tab
					label={trigger === "cross" ? <Translate value="createEditRule.trigger.selectLine"/> : this.props.displayName === "polygon" || "system" ? <Translate value={`createEditRule.trigger.select.${this.props.displayName}`}/> : <Translate value="createEditRule.trigger.selectDynamic" count={this.props.displayName}/>}
					style={styles.tabButton}
					value='b2'
					onActive={this.handleTabClick}
...
add
								...
								<ListItem
									className='add-rule-attribute'
									primaryText={trigger === "cross" ? <Translate value="createEditRule.trigger.anyLine"/> : this.props.displayName === "polygon" || "system" ? <Translate value={`createEditRule.trigger.anyDots.${this.props.displayName}`}/> : <Translate value="createEditRule.trigger.anyDynamicdots" count={this.props.displayName}/>}
									onClick={this.handleClick}
									leftIcon={
										<i
											className='material-icons'
