...
const CargoBerthFields = ({
	...
	const styles = {
		formControlLabel: {
			...(dir == "rtl" ? { marginRight: "-11px", marginLeft: "16px" } : {})
		},
		tableHead: {
			textAlign: "unset",
			paddingRight: 16,
		...
		tableBody: {
			...(dir == "rtl" ? { textAlign: "right", borderLeft: "1px solid #515151" } : { textAlign: "left", borderRight: "1px solid #515151" }),
			paddingRight: 16
		},
		fabWrapper: {
			display: "flex",
		...
		typography: {
			...(dir == "rtl" ? { marginRight: 8 } : { marginLeft: 8 })
		}
	};
						...
						<Table>
							<TableHead>
								<TableRow style={{ height: "auto" }}>
									<TableCell style={styles.tableHead}><Translate value="formPanel.cargoBerthAssg.table.head.cargo" /> </TableCell>
									{cargoDirectionEnabled && (<TableCell style={styles.tableHead}><Translate value="formPanel.cargoBerthAssg.table.head.direction" /></TableCell>)}
									<TableCell style={styles.tableHead}><Translate value="formPanel.cargoBerthAssg.table.head.weight" /></TableCell>
									<TableCell style={styles.tableHead}><Translate value="formPanel.cargoBerthAssg.table.head.shipper" /></TableCell>
									<TableCell style={{ ...styles.tableHead, padding: "4px 0px 4px 12px" }}>
								...
								{cargo.map((c, index) => {
									...
									return (
										<TableRow key={index}>
											...
											<TableCell style={{ textAlign: "unset", paddingRight: 16 }}>
												<SearchSelectField
													id="shipper-receiver"
