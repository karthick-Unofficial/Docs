...
const LookupManager = ({ closeManager, open, selectManager, type, imoRequired, mmsiRequired, user, dir }) => {
	const styles = {
		button: {
			paddingTop: 0,
			paddingBottom: 0
	...
	return (
		...
		>
			{type && (
				<div style={dir == "rtl" ? { position: "absolute", top: 16, left: 16 } : { position: "absolute", top: 16, right: 16 }}>
			...
			>
				<List>
					<ListItem style={dir == "rtl" ? styles.listItemRTL : { paddingBottom: 6 }}>
						<ListItemText
					...
					<ListItem
						...
						button
						style={dir == "rtl" ? { ...styles.listItemRTL, ...styles.button } : styles.button}
					>
						<ListItemText
				...
				<Divider />
				<List>
					<ListItem style={dir == "rtl" ? { ...styles.listItemRTL, paddingBottom: 6 } : { paddingBottom: 6 }}>
						<ListItemText
