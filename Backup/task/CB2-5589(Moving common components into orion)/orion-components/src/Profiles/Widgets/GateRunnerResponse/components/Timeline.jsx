...
import { makeGetCollectionMembers } from "orion-components/GlobalData/Selectors";
...
const Timeline = (props) => {
    ...
    //interdiction point entities
    const getCollectionMember = makeGetCollectionMembers();
    const entities = useSelector(state => size(collection[0]) ? getCollectionMember(state, { collection: collection[0] }) : []);
