	...
	render () {
		...
		const shapesAddActions = [
			<FlatButton
				...
				label={<Translate value="createEditRule.trigger.triggerDialog.cancel"/>}
				onClick={this.handleCancelClick}
				primary={true}
			/>,
			<FlatButton
				style={styles.buttonStyles}
				label={<Translate value="createEditRule.trigger.triggerDialog.addItem"/>}
				...
				>
	                <ErrorBoundary>
		                <TypeAheadFilterContainer
		                    ...
		                    placeholder={this.placeholderConverter("createEditRule.trigger.triggerDialog.wantToFind")}
		                />
	                </ErrorBoundary>
