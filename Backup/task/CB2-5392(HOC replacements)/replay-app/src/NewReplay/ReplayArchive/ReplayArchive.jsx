...
const deleteReplays = (selectedForDeletion, replays, updateReplays, updateSelectedForDeletion, dispatch) => {
		...
		<Fragment>
			...
			<Dialog
				...
				confirm={{
					...
					action: () => {
						deleteReplays(selectedForDeletion, replays, updateReplays, updateSelectedForDeletion, dispatch);
					}
				}}
			/>
			<Dialog
