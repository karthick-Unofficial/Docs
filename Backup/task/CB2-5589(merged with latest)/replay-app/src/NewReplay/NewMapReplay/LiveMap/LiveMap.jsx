...
import { RoadsAndLabels } from "orion-components/Map/Layers";
...
const ReplayMap = memo(
	({ style, zoom, center, minZoom, maxZoom, map, creatingReplay, updateMapCoordinates, baseMaps }) => {
		const dispatch = useDispatch();

		const { setMapReference, toggleMapVisible, setMapState } = actionCreators;
			...
			>
				...
				{map && (
					<Fragment>
						...
						<RoadsAndLabels map={map} defaultVisible={true} />
					</Fragment>
				)}
			</Map>
		);
