...
const StatusBoard = () => {
    ...
    const statusCards = useSelector(state => state.statusCards && state.statusCards.cards);
    ...
    return (
        <div style={{ overflow: "scroll", height: "calc(100% - 80px)", width: "90%", margin: "auto" }}>
            <h3 style={{ fontFamily: "roboto", fontSize: "14px", fontWeight: 400, color: "#fff" }}><Translate value="global.dock.statusBoard.title" /></h3>
