		...
		<div className={`summary-wrapper ${scrolledUp ? "scrolled-up" : ""} `}>
			<ListItem className="summary-info" disableGutters>
				...
				<ListItemText className={` ${scrolledUp ? "MuiTypography-noWrap" : ""}`}
					...
					secondary={
						ownerName
							? getTranslation("global.profiles.widgets.summary.createdBy", "", localizeType(displayType || type), ownerName)
			...
			{!scrolledUp && (buttons || description) && (
				<div style={{ padding: "0 10px" }}>
					<div className="summary-description" style={dir === "rtl" ? { textAlign: "right", marginRight: "5px" } : {}}>
						<p>{description}</p>
					</div>
					<div
						style={{
