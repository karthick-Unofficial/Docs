		...
		<Fragment>
			...
			>
				<Typography variant="h6">
					{context ? (
						<Translate value="drawingPanel.facilityForm.editFacility" />
					) : (
				...
				<div style={{ float: "left", direction: dir }}>
					...
					<Button onClick={handleSave} disabled={!feature || !name} classes={{ disabled: classes.disabled }}>
			...
			<TextField
				...
				InputProps={{
					classes: { root: classes.root, input: classes.input },
					style: { lineHeight: "unset", padding: 0 }
				}}
				multiline={true}
				rows={4}
				rowsMax={6}
