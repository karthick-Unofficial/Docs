...
const AppMenuWrapper = ({ isHydrated }) => {
	...
	return (
		<div style={{ height: 48 }}>
			<AudioAlertPlayer />
			<IconButton onClick={handleTouchTap} aria-describedby={id} sx={{ width: 48, height: 48 }}>
			...
			{isOpen && (
				...
				>
					{isHydrated && (
						<AppMenu user={user} org={org} emailConfig={emailConfig} dir={dir} dispatch={dispatch} />
					)}
				</Popover>
			)}
		</div>
...
AppMenuWrapper.propTypes = propTypes;
