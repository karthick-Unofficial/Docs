...
export const nauticalChartLayerOpacitySelector = createSelector(persistedState, (state) =>
	state.nauticalChartLayerOpacity !== null && state.nauticalChartLayerOpacity !== undefined
		? state.nauticalChartLayerOpacity
		: 1
);

export const roadAndLabelLayerOpacitySelector = createSelector(persistedState, (state) =>
	state.roadAndLabelLayerOpacity !== null ? state.roadAndLabelLayerOpacity : 1
);

export const weatherRadarLayerOpacitySelector = createSelector(persistedState, (state) =>
	state.weatherRadarLayerOpacity !== null && state.weatherRadarLayerOpacity !== undefined
