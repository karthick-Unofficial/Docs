import { eventService, attachmentService, activityService } from "client-app-core";
...
export function loadEntityDetail(obj) {
	return function (dispatch, getState) {
		...
		activityService.subscribeByTarget(obj.id, obj.entityType, function (err, response) {
			if (err) {
				console.log(err);
			}
			if (!response) {
