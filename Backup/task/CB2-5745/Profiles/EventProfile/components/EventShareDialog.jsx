...
const EventShareDialog = ({
	...
	const sharePromptText = event.isTemplate
		? getTranslation(
				"global.profiles.eventProfile.eventShareDialog.sharePromptTemplate"
		  )
		: getTranslation(
				"global.profiles.eventProfile.eventShareDialog.sharePromptEvent"
		  );
		...
		<React.Fragment>
			...
			<Dialog
				...
				confirm={{
					label: getTranslation(
						"global.profiles.eventProfile.eventShareDialog.confirm"
					),
					action: () => handleConfirmPublish(event.id)
				}}
				abort={{
					label: getTranslation(
						"global.profiles.eventProfile.eventShareDialog.cancel"
					),
			...
			<Dialog
				...
				title={
					orgs.length >= 1
						? getTranslation(
								"global.profiles.eventProfile.eventShareDialog.shareTitle",
								event.name
						  )
						: getTranslation(
								"global.profiles.eventProfile.eventShareDialog.noOrganizations"
						  )
				}
				dir={dir}
			>
