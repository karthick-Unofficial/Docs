		...
		<div style={styles.wrapper}>
			...
			<div style={{ ...styles.sectionHeader, marginBottom: "24px" }}>
				...
				<div style={{ display: "flex" }}>
					<p style={{ paddingRight: "16px" }}><Localize value={moment(date).format("dddd")} dateFormat="date.day"/></p>
						...
						return (
							<ListItem button key={index} onClick={() => editAssignment(assignment)}>
								<div key={index} style={styles.dailyAgenda.listItem}>
									<p style={{ width: "160px", color: `${assignment.overdue ? "#E85858" : "white"}` }}>
			...
			<div style={{ ...styles.sectionHeader, marginBottom: "16px" }}>
				...
				<div style={{ display: "flex" }}>
					<p style={{ paddingRight: "16px" }}>{moment(date).format("dddd")}</p>
					<p><b>{moment(date).format("MMMM D, YYYY")}</b></p>
				</div>
