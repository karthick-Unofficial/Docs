			...
			case "Pinned Items": {
				return canManage ? (
					<div className="widget-option-button">
						{!eventEnded && (
							<FlatButton
								label={getTranslation("eventView.pinItem")}
								primary={true}
			...
			case "Event Lists": {
				return (
					<div className="widget-option-button">
						{canManage ? (
							<FlatButton
								label={getTranslation("eventView.addList")}
								primary={true}
				...
				return (
					<div>
						{this.state.notesChanged ? (
							<div className={"widget-option-button"}>
								<FlatButton
									label={getTranslation("eventView.cancel")}
									secondary={true}
									onClick={() => this.dynamicWidget.current.cancelEdit()}
								/>
								<FlatButton
									label={getTranslation("eventView.save")}
									primary={true}
			...
			case "Proximity": {
				return canManage ? (
					<div className="widget-option-button">
						{!eventEnded && (
							<FlatButton
								label={getTranslation("eventView.createProxZone")}
								primary={true}
		...
		return !mobile ? (
			<div style={{ height: `calc(100vh - ${WavCamOpen ? "288px" : "48px"})` }} className="view-wrapper">
				...
				>
					...
					{this.getEventView(event ? view : "map-view")}
				</div>
			</div>
		) : (
			<div />
