...
// Components
import EventsMapLayersContainer from "./EventsMapLayers/EventsMapLayersContainer";
...
class MapBaseMapboxGL extends Component {
	...
	setPosition = map => {
		...
		this.props.setMapPosition(newCoords, map.getZoom());
	};
	...
	render() {
		...
		return (
			...
			>
				...
				{this.state.map && (
					<ErrorBoundary>
						<EventsMapLayersContainer map={this.state.map} />
						<FacilitiesContainer />
						<ActiveFloorPlansContainer />
