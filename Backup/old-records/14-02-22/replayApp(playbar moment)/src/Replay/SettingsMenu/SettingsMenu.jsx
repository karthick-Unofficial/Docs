		...
		>
			...
			<div style={{ margin: "0 16px", padding: "8px 0px" }}>
				<LayerToggleContainer
					label={<Translate value="replay.settingsMenu.settings.map" />}
					updateKey="entityLabels"
				/>
				<LayerToggleContainer
					label={<Translate value="replay.settingsMenu.settings.camera" />}
			...
			<div style={{ margin: "0 16px", padding: "16px 0px 8px" }}>
				...
				<LayerToggleContainer
					label={<Translate value="replay.settingsMenu.settings.charts" />}
					updateKey="nauticalCharts"
					withOpacity={true}
				/>
				<LayerToggleContainer
					label={<Translate value="replay.settingsMenu.settings.road" />}
			...
			<div style={{ margin: "0 16px", padding: "16px 0px 8px", maxHeight: 730 }}>
				...
				<List style={{ height: "calc(100% - 35px)" }}>
					...
					<LayerToggleContainer
						label={<Translate value="replay.settingsMenu.settings.events" />}
						updateKey="Event"
					...
					/>
					<LayerToggleContainer
						label={<Translate value="replay.settingsMenu.settings.points" />}
						updateKey="Point"
					...
					/>
					<LayerToggleContainer
						label={<Translate value="replay.settingsMenu.settings.polygons" />}
						updateKey="Polygon"
					...
					/>
					<LayerToggleContainer
						label={<Translate value="replay.settingsMenu.settings.lines" />}
						updateKey="Line"
