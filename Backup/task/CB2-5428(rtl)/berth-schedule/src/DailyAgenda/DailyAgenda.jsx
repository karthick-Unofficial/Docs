...
const DailyAgenda = () => {
	...
	const styles = {
		...
		days: {
			...(dir === "rtl" ? { paddingLeft: "16px" } : { paddingRight: "16px" })
		}
	};
		...
		<div style={styles.wrapper}>
			...
			<div style={{ ...styles.sectionHeader, marginBottom: "24px" }}>
				...
				<div style={{ display: "flex" }}>
					<p style={styles.days}><Translate value={`days.long.${moment(date).format("dddd")}`} /></p>
						...
						return (
							<ListItem button key={index} onClick={() => dispatch(editAssignment(assignment))}>
								<div key={index} style={styles.dailyAgenda.listItem}>
									<p style={{ width: "160px", textAlign: "unset", color: `${assignment.overdue ? "#E85858" : "white"}` }}>
