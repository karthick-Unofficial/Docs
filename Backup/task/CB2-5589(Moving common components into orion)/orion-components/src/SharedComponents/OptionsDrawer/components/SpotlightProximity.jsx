...
const SpotlightProximity = ({ globalState, updateGlobalSettings, dir }) => {
    ...
    return (
        <section>
            <Typography variant="subtitle1"><Translate value="global.sharedComponents.optionsDrawer.spotlightProx.title" /></Typography>
            <div style={{ display: "flex", alignItems: "flex-start" }}>
                <TextField
                    label={getTranslation("global.sharedComponents.optionsDrawer.spotlightProx.defaultProx")}
                    value={proximity}
                    ...
                    endAdornment={outputUnit == "km" ? getTranslation("global.sharedComponents.optionsDrawer.spotlightProx.km") : getTranslation("global.sharedComponents.optionsDrawer.spotlightProx.mi")}
                    endAdornmentStyles={{}}
