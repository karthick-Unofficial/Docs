...
export const feedEntitiesGeoByTypeSelector = entityType => createDeepEqualSelector(
	globalGeo,
	userIntegrations,
	(globalGeo, integrations) => {
		...
		_.each(
			...
			integration => {
				entities = { ...entities, ...globalGeo[integration.feedId].data };
			}
		);
		return entities;
	}
...
export const feedEntitiesWithGeoByTypeSelector = entityType => createDeepEqualSelector(
	globalData,
	globalGeo,
	userIntegrations,
...
export const userFeedsByTypeSelector = entityType => createSelector(
	userFeedState,
	(userFeed) => {
...
export const getFeedEntitiesByProperty = (state, feedId, property, value) => {
	if (
		state.globalData[feedId] &&
		state.globalData[feedId].data
	) {
