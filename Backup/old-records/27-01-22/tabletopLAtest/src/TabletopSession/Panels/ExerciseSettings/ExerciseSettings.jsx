...
const ExerciseSettings = ({
	...
	return (
		<div className={dir == "rtl" ? "exerciseSettingsContainerRTL" : "exerciseSettingsContainer"}>
			<div className="row">
				<SelectField
					...
					label={<Translate value="tableopSession.panels.excerciseSettings.simMode"/>}
					value={simulationMode}
					handleChange={(e) => setSimulationMode(sessionId, e.target.value)}
					items={[
						{ value: "simulation", id: "simulation", name: <Translate value="tableopSession.panels.excerciseSettings.simulation"/>},
						{ value: "playback", id: "playback", name: <Translate value="tableopSession.panels.excerciseSettings.playback"/> }
					]}
				...
				<SelectField
					...
					label={<Translate value="tableopSession.panels.excerciseSettings.controller"/>}
					value={controller}
			...
			<div className="row">
				{(user.id === controller) &&
					<div className="" style={dir == "rtl" ? { width: "100%", marginLeft: 51 } : { width: "100%", marginRight: 51 }}>
						<SelectField
							id="timerIntervalSelect"
							label={<Translate value="tableopSession.panels.excerciseSettings.modifySim"/>}
				...
				<div  className={user.id === controller ? "leftSpacing": "noSpacing"} >
					<SelectField
						id="timePrecision"
						label={<Translate value="tableopSession.panels.excerciseSettings.simTimePrecision"/>}
			...
			{(user.id === controller) &&
				<div className="row" style={dir == "rtl" ? {marginRight: -10, marginTop: 15} : {marginLeft: -10, marginTop: 15}}>
					<Switch 
						name="enableAudio" 
						onChange={(e) => setEnableAudio(e.target.checked)} 
						checked={sessionSettings && sessionSettings.hasOwnProperty("enableAudio") ? sessionSettings.enableAudio : true} 
					/>
					<Typography variant="body1" className="b1-white"><Translate value="tableopSession.panels.excerciseSettings.enableWeaponFire"/></Typography>
				</div>
			}
			<div style={{ marginTop: 72 }}>
				<div className="b1-white"><Translate value="tableopSession.panels.excerciseSettings.mapDisplaySett"/></div>
				<div className="b2-bright-gray" style={{ marginTop: 34 }}><Translate value="tableopSession.panels.excerciseSettings.setTraceDisplay"/></div>
				<Slider
					value={traceDuration}
					min={0}
					max={120}
			...
			<div className="b1-white" style={{ marginTop: 66 }}><Translate value="tableopSession.panels.excerciseSettings.mapSymbolSize"/></div>
			...
			<div className="symbolSizer">
				<div className="b2-bright-gray">
				<Translate value="tableopSession.panels.excerciseSettings.mapMarkers"/>
				</div>
				<Slider
			...
			<div className="symbolSizer">
				<div className="b2-bright-gray"><Translate value="tableopSession.panels.excerciseSettings.events"/></div>
				<Slider
