...
class CameraGeoMenu extends PureComponent {
	...
	render() {
		...
		let facilityName = "";
		let floorPlanName = "";
		const facilityCamera = entityType == "camera" && entityData.displayTargetId && entityData.displayType && entityData.displayType.toLowerCase() === "facility";
		const facilityAccessPoint = entityType == "accessPoint" && entityData.displayTargetId && entityData.displayType && entityData.displayType.toLowerCase() === "facility";
		console.log("facility", entityType);
		...
		return (
			<Fragment>
				...
				>
					{entityType == "accessPoint" && <MenuItem onClick={() => facilityAccessPoint ? this.props.openDialog("facilityWarningDialog") : this.handleSelect("accessPoint-edit")}>
						<ListItemIcon>
							<Edit style={{ color: "#FFF" }} />
						</ListItemIcon>
						<ListItemText primary={getTranslation("accessPointMapLayers.listItemText.editLocation")} />
					</MenuItem>}
					{entityType == "camera" && <MenuItem onClick={() => facilityCamera ? this.props.openDialog("facilityWarningDialog") : this.handleSelect("camera-edit")}>
						<ListItemIcon>
							<Edit style={{ color: "#FFF" }} />
						</ListItemIcon>
