...
export const berthAssignmentsReceived = data => {
	return {
...
export const berthAssignmentReceived = data => {
	return {
...
export const berthAssignmentRemoved = id => {
	return {
...
export const berthAssignmentUpdated = (id, data) => {
	return {
