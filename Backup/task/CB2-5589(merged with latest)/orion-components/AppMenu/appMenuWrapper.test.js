...
var _session = require("../testData/session");
var reactRedux = _interopRequireWildcard(require("react-redux"));
var _i18n = require("../testData/i18n");
var _clientConfig = require("../testData/clientConfig");
...
describe("AppMenuWrapper", function () {
  beforeEach(function () {
  ...
  it("renders", function () {
    ...
    var wrapper = (0, _enzyme.shallow)( /*#__PURE__*/_react["default"].createElement(_AppMenuWrapper["default"], null));
