...
const ShareStatusCardDialog = ({open, closeDialog, cardId, sharedWith}) => {
	...
	return (
		<Dialog
			open={open}
			confirm={{ label: getTranslation("global.sharedComponents.statusCard.shareStatusCardDialog.save"), action: () => save() }}
			abort={{ label: getTranslation("global.sharedComponents.statusCard.shareStatusCardDialog.cancel"), action: () => cancel() }}
