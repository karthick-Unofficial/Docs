...
var _tileOptionsActions = require("./tileOptionsActions");
...
var TileOptions = function TileOptions() {
  ...
  var _useState7 = (0, _react.useState)([]),
    ...
    BaseMaps = _useState8[0],
    setBaseMaps = _useState8[1];
  ...
  var SetMapStyle = function SetMapStyle(style) {
    dispatch((0, _tileOptionsActions.setMapStyle)(style));
    setOpen(false);
  };
