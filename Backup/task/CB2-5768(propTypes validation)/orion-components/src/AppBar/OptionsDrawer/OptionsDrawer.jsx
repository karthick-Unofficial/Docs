...
const propTypes = {
	...
	cameraFeeds: PropTypes.oneOfType([PropTypes.array, PropTypes.object]),
	cameraFOV: PropTypes.oneOfType([PropTypes.array, PropTypes.object]),
			...
			<List>
				...
				{settingsMenu ? (
					...
					<>
						<ListItem sx={styles.listItem}>
							<ListItemText
								primary={getTranslation("global.appBar.optionsDrawer.roadsLabels")}
								primaryTypographyProps={{
									style: { fontSize: 16 },
						...
						{disableSliders ? (
							...
							<Collapse style={{ padding: "0px 16px" }} in={roadsVisible}>
								<CBSlider
									...
									max={1}
									step={0.1}
									onChange={(e, value) => handleSliderChange(e, value, "roadAndLabels")}
									onChangeCommitted={(e, value) =>
										handleSliderChangeCommitted(e, value, "roadAndLabels")
									}
								/>
							</Collapse>
						)}
