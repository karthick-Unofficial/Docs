(function (global, factory) {
	if (typeof define === "function" && define.amd) {
		...
		global.CBDatePicker = mod.exports;
	}
	...
	var CBDatePicker = function (_Component) {
		_inherits(CBDatePicker, _Component);

		function CBDatePicker() {
			var _ref;

			var _temp, _this, _ret;

			_classCallCheck(this, CBDatePicker);

			for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
				args[_key] = arguments[_key];
			}

			return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = CBDatePicker.__proto__ || Object.getPrototypeOf(CBDatePicker)).call.apply(_ref, [this].concat(args))), _this), _this.formatDateLabel = function (date, invalidLabel, format) {
				return date === null ? "" : format && date ? _clientAppCore.timeConversion.convertToUserTime(date, format) : invalidLabel;
			}, _temp), _possibleConstructorReturn(_this, _ret);
		}

		_createClass(CBDatePicker, [{
			key: "render",
