...
const EventSharing = ({classes, eventInfo, userInfo, selfAgent, agents, simTimePrecision, simulationData, sessionId, simId, simTime, shareEvents, communications, onClose, dir}) => {
	...
	return (
		<Container className={ classes.flexContainer} style={{width:700}}>
			<div className={ classes.flexContainerHorizontalStart}>
				<div style={dir == "rtl" ? {marginRight:15, marginRight:10} : {marginLeft:15, marginRight:10}}><AlertRhombus style={{color: "white"}} /></div>
				<div style={dir == "rtl" ? {marginRight:10} : {marginLeft:10}}><EventTextContainer eventData={eventInfo.getData(agents, simulationData)}/></div>
			</div>
			
			<div className={ classes.flexContainer} style={dir == "rtl" ? {width:"100%", paddingTop:20, paddingRight:10, marginTop:30} : {width:"100%", paddingTop:20, paddingLeft:10, marginTop:30}}>
				{
					!isFacilitator() && 
					<Typography variant="body1" className="b1-bright-gray" style={dir == "rtl" ? {marginRight:10, color:"#b5b9be", display: "inline-block"} : {marginLeft:10, color:"#b5b9be", display: "inline-block"}}><Translate value="tableopSession.panels.events.eventSharing.chooseCommDevices"/></Typography>
				}
				{
					isFacilitator() && 
					<div>
						<Typography variant="body1" className="b1-bright-gray" style={dir == "rtl" ? {marginRight:10, color:"#b5b9be", display: "inline-block"} : {marginLeft:10, color:"#b5b9be", display: "inline-block"}}><Translate value="tableopSession.panels.events.eventSharing.choosePlayers"/></Typography>
						<div style={{display: "inline-block", float: "right"}} className="selectAllTeam">
							...
							<span><Translate value="tableopSession.panels.events.blueTeam"/></span>
							...
							<span><Translate value="tableopSession.panels.events.redTeam"/></span>
						</div>
					</div>
				}
				{
					isFacilitator() && <TableContainer className={classes.tableContainer}>
						<Table size="small" aria-label="event sharing table">
							<TableHead>
								<TableRow>
									<TableCell> </TableCell>
									<TableCell align="left" width="80" color="#b5b9be"><div style={{color:"#b5b9be"}}><Translate value="tableopSession.panels.events.eventSharing.team"/></div></TableCell>
									<TableCell align="left" color="#b5b9be"><div style={{color:"#b5b9be"}}><Translate value="tableopSession.panels.events.eventSharing.player"/></div></TableCell>
									<TableCell align="left"><div style={{color:"#b5b9be"}}><Translate value="tableopSession.panels.events.eventSharing.time"/></div></TableCell>
								</TableRow>
							</TableHead>
							<TableBody>
					...
					!isFacilitator() && <TableContainer className={classes.tableContainer}>
						<Table size="small" aria-label="comm sharing table">
							<TableHead>
								<TableRow>
									<TableCell> </TableCell>
									<TableCell align="left"><div style={{color:"#b5b9be"}}><Translate value="tableopSession.panels.events.eventSharing.comm"/>&nbsp;<Translate value="tableopSession.panels.events.eventSharing.device"/></div></TableCell>
									<TableCell align="left"><div style={{color:"#b5b9be", width:150}}><Translate value="tableopSession.panels.events.eventSharing.owner"/></div></TableCell>
									<TableCell align="left"><div style={{color:"#b5b9be"}}><Translate value="tableopSession.panels.events.eventSharing.recipients"/></div></TableCell>
									<TableCell align="left"><div style={{color:"#b5b9be"}}><Translate value="tableopSession.panels.events.eventSharing.time"/></div></TableCell>
								</TableRow>
							</TableHead>
							<TableBody>
										...
										<TableCell align="left">{
											<div style={{color: "#414449"}}>
												<List key={comm.id} component="nav" aria-label={"View recipients"}>
													...
													>
														<ListItemText primary={<span style={{color:"#4DB5F4", marginLeft:-12}}><Translate value="tableopSession.panels.events.eventSharing.viewRecipients"/></span>}/>
			...
			<Container className={dir == "rtl" ? classes.dialogActionsRTL : classes.dialogActions}>
				<Button style={dir == "rtl" ? { width: 156, marginRight:10, marginLeft:0} : { width: 156, marginLeft:10, marginRight:0}} onClick={onClose}><Translate value="tableopSession.panels.events.eventSharing.cancel"/></Button>
				<Button variant="contained" color="primary" disabled={disabledNotify()} style={dir == "rtl" ? { width: 156, marginLeft:10, marginRight:0} : { width: 156, marginLeft:0, marginRight:10 }} onClick={handleNotify}><Translate value="tableopSession.panels.events.eventSharing.notify"/></Button>
			</Container>
