...
const propTypes = {
	...
	paperPropStyles: PropTypes.object,
	titlePropStyles: PropTypes.object,
	dir: PropTypes.string,
	classes: PropTypes.object,
	dialogContentStyles: PropTypes.object,
	actionPropStyles: PropTypes.object,
	actions: PropTypes.bool,
	DialogActionsFunction: PropTypes.func
};
	...
	return (
		<Dialog
			...
			PaperProps={{
				sx: {
					...styles.dialog,
					...(paperPropStyles ? paperPropStyles : {})
				}
			}}
			open={open}
		...
		>
			{title && (
				<DialogTitle sx={{ ...styles.title, ...titlePropStyles }} disableTypography={true}>
					{title}
				</DialogTitle>
			)}
				...
				<DialogActions>
					{deletion &&
						...
						(deleteConfirmation ? (
							...
							>
								{deletionConfirm ? (
									<Translate value="global.CBComponents.CBDialog.confirmDelete" />
								) : (
									deletion.label
								)}
							</Button>
