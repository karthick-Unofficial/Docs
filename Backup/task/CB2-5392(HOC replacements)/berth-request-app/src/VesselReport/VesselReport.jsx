...
import ScheduleField from "../BerthRequestForm/ScheduleField/ScheduleField";
								...
								<div style={styles.flexContainer}>
									...
									<div style={styles.halfWidth}>
										...
										<div style={styles.fieldLines}>
											<TextField
												id="ata"
												value={moment.tz(ata, timezone).format("MMMM Do YYYY, h:mm:ss a")}
												handleChange={() => { }}
												disabled={true}
												dir={dir}
											/>
									...
									<div style={styles.halfWidth}>
										...
										<div style={styles.fieldLines}>
											<TextField
												id="ata"
												value={moment.tz(atd, timezone).format("MMMM Do YYYY, h:mm:ss a")}
												handleChange={() => { }}
												disabled={true}
												dir={dir}
											/>
