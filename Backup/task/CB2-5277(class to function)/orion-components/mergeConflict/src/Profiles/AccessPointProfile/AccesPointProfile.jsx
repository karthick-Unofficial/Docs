...
const AccessPointProfile = ({
		...
		DEFAULT_WIDGET_CONFIG = [
			{
				enabled: true,
				id: "access_control",
				name: getTranslation("global.profiles.accessPointProfile.accessControlWidget.name")
			},
			{
				enabled: true,
				id: "files",
	...
	const getWidgetConfig = () => {
		const defaultTypes = ["access_control", "files", "activities", "linked_items", "cameras"];
