...
const I18n = ({ appId, children }) => {
	...
	const authenticated = useSelector(
		(state) => state.session.identity.isAuthenticated
	);
	const ready = useSelector(
		(state) =>
			state.i18n &&
			state.i18n.translations &&
			Object.keys(state.i18n.translations).length > 0
	);
	...
	return authenticated ? ready ? children : <div /> : children;
};
