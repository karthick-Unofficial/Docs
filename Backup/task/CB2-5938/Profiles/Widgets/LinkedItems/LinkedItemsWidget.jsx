...
import WidgetMenu from "orion-components/Profiles/Widgets/LinkedItems/components/WidgetMenu";
...
const LinkedItemsWidget = ({
	...
	const linkedItems =
		useSelector((state) => getSelectedContextData(state)(contextId, "linkedEntities"), isEqual) ?? [];
	const fovItems = useSelector(
		(state) => (entityType === "camera" ? getSelectedContextData(state)(contextId, "fovItems") ?? [] : []),
		isEqual
	);
