...
const Alarm = ({
	...
	const feedOptions = [{value: "", label: placeholderConverter("createEditRule.genericAttribute.type.none")}], filterOptions = [{value: "", label: placeholderConverter("createEditRule.genericAttribute.type.none")}], subFilterOptions = [{value: "", label: placeholderConverter("createEditRule.genericAttribute.type.none")}];
