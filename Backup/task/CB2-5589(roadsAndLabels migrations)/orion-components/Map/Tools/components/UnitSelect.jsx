		...
		<Fragment>
			...
			>
				<MenuItem onClick={() => handleClick("nautical-miles")}>
					<ListItemText primary={getTranslation("global.map.tools.unitSelect.nauticalMiles")} style={styles.textAlignRight} />
				</MenuItem>
				{landUnitSystem === "metric" ? (
					<MenuItem onClick={() => handleClick("kilometers")}>
						<ListItemText primary={getTranslation("global.map.tools.unitSelect.kilometers")} style={styles.textAlignRight} />
					</MenuItem>
				) : (
					<MenuItem onClick={() => handleClick("miles")}>
						<ListItemText primary={getTranslation("global.map.tools.unitSelect.miles")} style={styles.textAlignRight} />
					</MenuItem>
				)}
			</Popover>
		</Fragment>
