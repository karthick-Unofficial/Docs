	...
	return (
		<section>
			...
			<div style={{ display: "flex", alignItems: "flex-start" }}>
				<TextField
					label={getTranslation("appBar.optionDrawer.spotlightProx.defaultProx")}
					value={proximity}
					...
					endAdornment={outputUnit == "km" ? getTranslation("appBar.optionDrawer.spotlightProx.km") : getTranslation("appBar.optionDrawer.spotlightProx.mi")}
					endAdornmentStyles={{}}
