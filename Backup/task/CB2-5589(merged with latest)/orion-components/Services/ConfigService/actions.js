...
var clientConfigReceived = function clientConfigReceived(data) {
  return {
    type: t.CLIENT_CONFIG_RECEIVED,
    payload: data
  };
};
var getClientConfig = function getClientConfig(setReady) {
  return function (dispatch) {
    _clientAppCore.applicationService.getApplicationConfig(function (err, res) {
      if (err) {
