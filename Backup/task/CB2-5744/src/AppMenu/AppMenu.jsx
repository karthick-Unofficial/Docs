...
const AppMenu = ({ user, org, emailConfig, dir, logOut, dispatch }) => {
	...
	const filteredApps = [...userApps, ...defaultApps].filter(
		(app) => !(window.location.href.indexOf(app.appId) > -1)
	);
	...
	return (
		<div className="app-menu-wrapper">
			<div className="user-info">
				...
				<div
					className={
						dir === "rtl" ? "user-detailsRTL" : "user-details"
					}
				>
					<div>{user.name}</div>
					<span>{title}</span>
