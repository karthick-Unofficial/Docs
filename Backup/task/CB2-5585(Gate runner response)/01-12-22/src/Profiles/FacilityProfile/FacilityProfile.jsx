import React, { Fragment, useEffect, memo, useState, useCallback, useMemo, useRef } from "react";
...
import {
	startFloorPlanCameraStream, startFloorPlanAccessPointsStream,
	startActivityStream, unsubscribeFromFeed, startCamerasInRangeStream
...
import {
	removeFloorPlanCameraSub, removeFloorPlanAccessPointsSub,
	attachFilesToFacility, deleteFacility
...
const FacilityProfile = ({
	...
	const getCustomWidgetConfig = (widgetName) => {
		...
		integrations.filter((customWidget) => {
			if (entity.feedId === customWidget.feedId && customWidget.hasOwnProperty('widgets')) {
