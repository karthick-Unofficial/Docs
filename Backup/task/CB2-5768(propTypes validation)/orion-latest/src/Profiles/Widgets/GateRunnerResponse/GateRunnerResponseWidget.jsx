...
import { startGateRunnerActivityStream, startAttachmentStream, unsubscribeFromFeed } from "orion-components/ContextualData/Actions";
...
const GateRunnerResponseWidget = (props) => {
	const { id, event, selectWidget, selected, subscriberRef, activities, expanded } = props;
