...
import { flushAllPromises, safelyMock, checkMockedUrl, getMockedMethod, getSentData } from "../../lib/test-utils.js";
...
describe("Notifications Sync Actions", () => {
	...
	it("Should create an action to close bulk notifications", () => {
		...
		expect(actions.closeBulkNotifications(notifications.map((n) => n.id))).toEqual(expectedAction);
	});
