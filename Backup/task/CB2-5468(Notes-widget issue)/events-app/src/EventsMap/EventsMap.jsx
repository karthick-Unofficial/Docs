...
function EventsMapWrapper() {
	...
	const settings = useSelector(state => !_.isEmpty(appState.persisted) ? mapSettingsSelector(state) : null);
	const zoom = !_.isEmpty(appState.persisted) ? settings.mapZoom : mapZoom;
	const center = !_.isEmpty(appState.persisted) ? settings.mapCenter : mapCenter;
