...
const CBTextField = ({
	...
	const styles = {
		...
		inputLabel: {
			...(dir === "ltr" && { left: "-15px" }),
			...(dir === "rtl" && { left: "unset", transformOrigin: "top right", right: "15px" }),
			...inputLabelStyle
		}
	};
	...
	return (
		...
		>
			{label &&
				<InputLabel style={styles.inputLabel} classes={{ formControl: classes.formControl, shrink: classes.shrink }} shrink={labelShrink}>
					{label}
				</InputLabel>}
			<Input
				id={id}
				...
				endAdornment={
					endAdornment ? (
						<InputAdornment
							style={endAdornmentStyles || (dir && dir == "rtl" ? styles.iconLeft : styles.iconRight)}
				...
				autoComplete="off"
				autoFocus={autoFocus}
				classes={{ underline: dottedInputUnderline ? classes.dottedUnderline : classes.underline }}
				placeholder={placeholder}
			/>
			{helperText &&
				<FormHelperText
					sx={{ overflowWrap: "break-word", textAlign: (dir && dir == "rtl" ? "right" : "left"), margin: "3px 0 0 0" }}
				>
					{helperText}
				</FormHelperText>
			}
