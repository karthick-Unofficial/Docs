...
describe("notifications reducer", () => {
	...
	describe("Should handle initialNotificationsReceived", () => {
		it("Should add notifications correctly to activeItems", () => {
			...
			expect(notifications(initialState, action).activeItems).toEqual(expectedState.activeItems);
		});
		...
		it("Should add notifications correctly to activeItemsById", () => {
			...
			expect(notifications(initialState, action).activeItemsById).toEqual(expectedState.activeItemsById);
		});
	});
	...
	describe("Should handle getArchiveSuccess", () => {
		...
		it("Should add notifications correctly to archiveItems if empty", () => {
			...
			expect(notifications(initialState, action).archiveItems).toEqual(expectedState.archiveItems);
		});
		...
		it("Should add notifications correctly to archiveItemsById if empty", () => {
			...
			expect(notifications(initialState, action).archiveItemsById).toEqual(expectedState.archiveItemsById);
		});
	});
});
