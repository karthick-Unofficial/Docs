...
const ModificationEditor = ( { map, simTime, data, modificationMode, modificationsConfig, 
	createModification, updateModification, onSaveModification, onCancelModication, floorPlans, raiseError, dir} ) => {
		...
		if (selectorControl === "text"){
			...
			return (
				<div style={{flex:1, marginLeft: 10, marginRight: 10 }}>
					...
					itemSelectionHandler ={conditionItemSelectionHandler} dir={dir}/>
				</div>
			);
	...
	return (
		<div>
			<div className="modificationflex">
				{
					(modificationMode ==="ADD") && <Typography variant="body1" className="b1-white" style={{margin:"10px 0px", alignSelf:"center", flex:1, fontSize:18}}>{<Translate value="tableopSession.panels.modifications.modificationEditor.main.addMod"/>}</Typography>
				}
				{
					(modificationMode !=="ADD") && <Typography variant="body1" className="b1-white" style={{margin:"10px 0px", alignSelf:"center", flex:1, fontSize:18}}>{<Translate value="tableopSession.panels.modifications.modificationEditor.main.editMod"/>}</Typography>
				}

				<div className="modificationActionsRight">
					<Button style={dir == "rtl" ? { width: 74, marginRight:10, marginLeft:0} : { width: 74, marginLeft:10, marginRight:0}} onClick={handleClose}><Translate value="tableopSession.panels.events.eventSharing.cancel"/></Button>
					<Button variant="contained" color="primary" style={{ width: 74, marginLeft:10, marginRight:10 }} 
						...
						}}><Translate value="tableopSession.panels.modifications.modificationEditor.main.save"/></Button>
				</div>
			</div>

			<div className={displayTextControl()? "modificationflex": "modificationflexColumn"}>
				<div style={{width: 260}}>
					<SelectField id="behaviorSelect" label={<Translate value="tableopSession.panels.modifications.modificationEditor.main.behaviour"/>} handleChange={(e)=>handleBehaviorChange(e.target.value)}
						formControlProps={{
			...
			<div className="modificationflex" style={{paddingLeft:5, paddingRight:5, marginTop:20}}>
				<div className="modificationItemContainer" style={{marginTop:5, marginBottom:5, minHeight:70, width: "100%"}}>
					...
					{/* Modification desc */}
					<div className="modificationflexColumn" style={dir == "rtl" ? {margin:5, marginRight:10, width:"100%"} : {margin:5, marginLeft:10, width:"100%"}}>
