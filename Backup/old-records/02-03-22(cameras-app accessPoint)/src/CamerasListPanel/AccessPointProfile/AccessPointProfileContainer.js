...
import * as actionCreators from "./accessPointProfileActions.js";
...
const mapStateToProps = state => {
	...
	if (isLoaded) {
		...
		// Check if accessPoint is the primary context
		const isPrimary =
...
const AccessPointProfileContainer = connect(
	mapStateToProps,
	mapDispatchToProps
)(AccessPointProfile);

export default AccessPointProfileContainer;
