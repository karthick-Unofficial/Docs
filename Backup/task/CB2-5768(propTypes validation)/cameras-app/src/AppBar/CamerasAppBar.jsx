...
const CamerasAppBar = () => {
	...
	return (
		<div>
			<AppBar titleText="Cameras" toggleOptionsDrawer={toggleOptionsDrawer} map={map} isMenu={true} />
			<ErrorBoundary>
				<OptionsDrawer open={optionsOpen} toggleClosed={toggleOptionsDrawer} spotlightProximity={true} />
			</ErrorBoundary>
		</div>
	);
};
