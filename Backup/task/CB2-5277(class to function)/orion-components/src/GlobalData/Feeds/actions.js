...
const feedPermissionReceived = (feedId, name, canView, source, entityType, ownerOrg, mapIconTemplate, profileIconTemplate, renderSilhouette, marineTrafficVisible = false) => {
	return {
