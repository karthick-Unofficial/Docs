	...
	return (
		<div>
			<div style={{display:"flex", flexDirection:"row-reverse", paddingRight:"10px"}}>
				<Button disabled={!hasModificationhistory} style={{minHeight:"41px", width:"258px"}} variant="contained" color="primary" onClick={openPdf}><Translate value="tableopSession.widgets.modifications.modificationHistory.export"/></Button>
			</div>
			<div id="modificationHistory">
				<div id="report-title">
					<p className="pdfHeading"><Translate value="tableopSession.widgets.modifications.modificationHistory.modHistReport"/></p>
					<p>{getBaseSimName()}</p>
					<p><span><Translate value="tableopSession.widgets.modifications.modificationHistory.reportDate"/> </span><span>{currentdate.toLocaleString()}</span></p>
				</div>
				{
									...
									<div className="modificationHistoryflex" style={{width: "100%"}}>
										...
										{ (simkey === 0) && 
											<div className="nameContainer">
												<div className="b2-bright-gray" data-html2canvas-ignore="true"><Translate value="tableopSession.widgets.modifications.modificationHistory.currentExercise"/></div>
										...
										<Translate value="tableopSession.widgets.modifications.modificationHistory.time"/>{` ${simu.parentDivergeTime ? utilities.truncate(simu.parentDivergeTime, simTimePrecision) : 0}`}</div>
