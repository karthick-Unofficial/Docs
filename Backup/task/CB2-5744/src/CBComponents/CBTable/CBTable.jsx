			...
			<TableRow>
				...
				{_.map(columns, (column) => (
					<TableCell
						...
						classes={{
							head:
								dir === "rtl" ? classes.headRTL : classes.head,
							paddingCheckbox:
								dir === "rtl"
									? classes.paddingCheckboxRLT
									: classes.paddingCheckbox
						}}
						padding={
							column.type === "checkbox" ? "checkbox" : "normal"
						}
					>
						{column.name}
					</TableCell>
			...
			{_.map(columns, (column) => {
				...
				return (
					<TableCell
						...
						classes={{
							body:
								dir === "rtl" ? classes.bodyRTL : classes.body,
							paddingCheckbox:
								dir === "rtl"
									? classes.paddingCheckboxRTL
									: classes.paddingCheckbox
						}}
						key={column.id}
					...
					>
						{_.isBoolean(value) ? (
							<CBCheckbox
								checked={value}
								handleChange={() =>
									handleCheckboxToggle(row.order, column.id)
								}
							...
							>
								{getTranslation(
									"global.CBComponents.CBTable.viewNotes"
								)}
							</Button>
						  ...
						  !value ? (
							...
							>
								{getTranslation(
									"global.CBComponents.CBTable.setNow"
								)}
							</Button>
						) : (
							value
