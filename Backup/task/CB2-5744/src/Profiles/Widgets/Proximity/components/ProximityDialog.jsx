...
const ProximityDialog = ({
	...
	return (
		<CBDialog
				...
				isEditing
					? {
							label: getTranslation(
								"global.profiles.widgets.proximity.proximityDialog.update"
							),
					...
					: {
							label: getTranslation(
								"global.profiles.widgets.proximity.proximityDialog.create"
							),
			...
			abort={{
				label: getTranslation(
					"global.profiles.widgets.proximity.proximityDialog.cancel"
				),
		...
		>
			...
			<div style={styles} className="radius">
				...
				<SelectField
					...
					id="distance-unit"
					label={getTranslation(
						"global.profiles.widgets.proximity.proximityDialog.unit"
					)}
			...
			<div style={{ padding: "12px 20px" }}>
				<ColorTiles
					...
					title={getTranslation(
						"global.profiles.widgets.proximity.proximityDialog.fillColor"
					)}
			...
			<div style={{ padding: "0px 20px" }}>
				<ColorTiles
					...
					title={getTranslation(
						"global.profiles.widgets.proximity.proximityDialog.strokeColor"
					)}
				...
				<StrokeProperties
					...
					type={strokeType}
					titleNoun={getTranslation(
						"global.profiles.widgets.proximity.proximityDialog.stroke"
					)}
