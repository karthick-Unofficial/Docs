...
var TargetingIcon = function TargetingIcon(props) {
  ...
  var shouldRender = !isDisabled && map && mapVisible && geometry && (!filters || !filters.length || (0, _includes["default"])(filters).call(filters, id));
  return shouldRender ? /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, multipleTargets ? geometry && (0, _map["default"])(geometry).call(geometry, function (data) {
    return draw && (0, _jquery["default"])(window).width() > 1023 && /*#__PURE__*/_react["default"].createElement(_TargetingLine["default"], {
      draw: draw,
      x: x,
      y: y,
      map: map,
