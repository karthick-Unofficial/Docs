	...
	const checkError = (type) => {
		switch (type) {
			case "unitName":
				setUnitNameError(
					getTranslation(
						"global.units.components.dialog.renameUnit.unitNameError"
					)
				);
				break;
			default:
		...
		<div>
			<Template
				...
				title={getTranslation(
					"global.units.components.dialog.renameUnit.title"
				)}
					...
					<div style={{ marginBottom: "25px" }}>
						<TextField
							...
							label={getTranslation(
								"global.units.components.dialog.renameUnit.unitName"
							)}
							fullWidth
							InputLabelProps={{
								style: {
