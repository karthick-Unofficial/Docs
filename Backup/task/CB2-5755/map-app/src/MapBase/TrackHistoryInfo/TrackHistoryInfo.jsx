					...
					>
						<div>
							...
							{popups[popupId].properties["lat"] && (
								<p key={`${popupId}-lat`}>
									<Translate value="mapBase.trackHistoryInfo.lat" />{" "}
									<UnitParser
							...
							{popups[popupId].properties["lng"] && (
								<p key={`${popupId}-lng`}>
									<Translate value="mapBase.trackHistoryInfo.lon" />{" "}
									<UnitParser
										sourceUnit={"decimal-degrees"}
										value={
											popups[popupId].properties["lng"]
							...
							{(popups[popupId].properties["speed"] ||
								...
								<p key={`${popupId}-speed`}>
									<Translate value="mapBase.trackHistoryInfo.speed" />{" "}
									{popups[popupId].properties["speed"]}
								</p>
							)}
							...
							{(popups[popupId].properties["hdg"] ||
								...
								<p key={`${popupId}-heading`}>
									<Translate value="mapBase.trackHistoryInfo.heading" />{" "}
									{popups[popupId].properties["hdg"]
										? popups[popupId].properties["hdg"]
										: popups[popupId].properties["heading"]}
									°
