...
export class FacilityService {
	...
	/**
     * Create a facility
     * @param {object} facility -- Facility data. Ex: { name: "Facility 1", description: "Facility in Boston", geometry: { coordinates: [], type: "polygon" } }
     * @param {function} callback 
     */
	create(facility, callback) {
		const url = "/ecosystem/api/facilities";
	...
	*/
	 ...
	 * @param {function} callback 
	 */
	 getAccessPointsForPlacing(callback) {
		const url = "/ecosystem/api/facilities/floorplanAccessPoints";
		this._restClient.exec_get(url, callback);
	}
