		...
		<Fragment>
			...
			>
				<MenuItem onClick={() => handleSelectEvent("draw_point")}>
					...
					<ListItemText primary={getTranslation("global.map.tools.shapeSelect.point")} style={styles.listItemAlign} />
				</MenuItem>
				<MenuItem onClick={() => handleSelectEvent("draw_polygon")}>
					<ListItemIcon sx={styles.listItemIcon}>
						<Layers />
					</ListItemIcon>
					<ListItemText primary={getTranslation("global.map.tools.shapeSelect.polygon")} style={styles.listItemAlign} />
				</MenuItem>
				<MenuItem onClick={() => handleSelectEvent("draw_line_string")}>
					<ListItemIcon sx={styles.listItemIcon}>
						<Timeline />
					</ListItemIcon>
					<ListItemText primary={getTranslation("global.map.tools.shapeSelect.line")} style={styles.listItemAlign} />
				</MenuItem>
			</Popover>
		</Fragment>
	);
