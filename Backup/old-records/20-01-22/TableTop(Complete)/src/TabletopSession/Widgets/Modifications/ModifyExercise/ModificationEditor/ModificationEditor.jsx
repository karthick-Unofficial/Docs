	...
	return (
		<div>
			<div className="modificationflex">
				{
					(modificationMode ==="ADD") && <Typography variant="body1" className="b1-white" style={{margin:"10px 0px", alignSelf:"center", flex:1, fontSize:18}}>{<Translate value="tableopSession.widgets.modifications.modificationEditor.main.addMod"/>}</Typography>
				}
				{
					(modificationMode !=="ADD") && <Typography variant="body1" className="b1-white" style={{margin:"10px 0px", alignSelf:"center", flex:1, fontSize:18}}>{<Translate value="tableopSession.widgets.modifications.modificationEditor.main.editMod"/>}</Typography>
				}
				...
				<div className="modificationActionsRight">
					...
					<Button variant="contained" color="primary" style={{ width: 74, marginLeft:10, marginRight:10 }} 
						...
						}}><Translate value="tableopSession.widgets.modifications.modificationEditor.main.save"/></Button>
				</div>
			</div>

			<div className={displayTextControl()? "modificationflex": "modificationflexColumn"}>
				<div style={{width: 260}}>
					<SelectField id="behaviorSelect" label={<Translate value="tableopSession.widgets.modifications.modificationEditor.main.behaviour"/>} handleChange={(e)=>handleBehaviorChange(e.target.value)}
						formControlProps={{
