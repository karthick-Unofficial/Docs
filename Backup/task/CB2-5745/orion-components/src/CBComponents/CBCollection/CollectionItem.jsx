...
const CollectionItem = ({
	...
	const profileIconTemplate =
		entityData && entityData.properties
			? entityData.properties.profileIconTemplate
			: null;
	return (
		<ListItem
			button
		...
		>
			...
			{type &&
				getIconByTemplate(type, item, "2rem", profileIconTemplate) && (
					<ListItemIcon>
						{getIconByTemplate(
							type,
							item,
