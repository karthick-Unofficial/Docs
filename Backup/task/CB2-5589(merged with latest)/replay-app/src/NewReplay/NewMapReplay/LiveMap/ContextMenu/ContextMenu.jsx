...
const ContextMenu = ({ map }) => {
	...
	const { startTrackHistoryStream, removeSubscriber, unsubscribeFromFeed, addNewContext } = actionCreators;
	...
	return (
		<Fragment>
			...
			>
				{track && (
					<MenuItem onClick={handleTrackHistory} style={trackHistoryOn ? { color: "rgb(53, 183, 243)" } : {}}>
						Toggle History
					</MenuItem>
				)}
