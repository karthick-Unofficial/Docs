...
const EditTextItem = ({ slide, index, handleChangeColor, handleChangeText, handleRemoveSlide, deleteDisabled, dir }) => {
		...
		<div style={itemStyles.container}>
			<div
				...
				style={{
					...
					...(isHovered && { boxShadow: `0 0 0 3px ${slide.color ? slide.color : "white"}`, cursor: "pointer" })
				}}
			/>
			<Popover
			...
			>
				<GithubPicker
					...
					colors={[
						"#008b02", "#fcac00", "#db0000", "#1273de", "#038795", "#3f3f3f", "#000000",
						"#7fc580", "#fdd57f", "#ed7f7f", "#88b9ee", "#81c3ca", "#9f9f9f", "#ffffff"
					]}
				/>
			</Popover>
			<div style={{ width: "70%", padding: "0 20px" }}>
				<TextField
					...
					id={`text-set-${index}`}
					variant="standard"
					label={getTranslation("shared.statusCard.StatusCardDialog.editSlide.fieldLabel.text")}
					value={slide.text}
			...
			{deleteDisabled
				? (
					<Tooltip title={getTranslation("shared.statusCard.StatusCardDialog.editSlide.fieldLabel.atleastOne")}>
		...
		>
			...
			<div style={styles.controls}>
				...
				<Typography variant="body1" style={styles.typography}>
					<Translate value="shared.statusCard.StatusCardDialog.editSlide.newSlide" />
				</Typography>
			</div>
		</div>
	);
