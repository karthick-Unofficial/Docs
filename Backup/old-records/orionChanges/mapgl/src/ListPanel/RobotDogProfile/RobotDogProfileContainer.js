...
import * as actionCreators from "./robotDogProfileActions.js";
import { appData } from "../../shared/utility/utilities";
import { RobotDogProfile } from "orion-components/Profiles";
import {
	collectionsSelector,
	feedInfoSelector
...
const RobotDogProfileContainer = connect(
	mapStateToProps,
	mapDispatchToProps
)(RobotDogProfile);
export default RobotDogProfileContainer;
