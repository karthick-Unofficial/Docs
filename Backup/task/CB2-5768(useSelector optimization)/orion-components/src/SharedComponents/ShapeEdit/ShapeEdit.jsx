...
const ShapeEdit = ({ app, mapTools, map, setMapTools, handleSave, classes, open, dir }) => {
			...
			<div style={{ overflowY: "scroll" }}>
				{app === "events-app" && (
					<div style={{ marginTop: 4, padding: "0px 20px" }}>
						<SelectField
							...
							dir={dir}
						>
							<MenuItem style={{ fontSize: 14 }} value={true} classes={{ selected: classes.selected }}>
								<Translate value="global.sharedComponents.shapeEdit.showWhenActive" />
							</MenuItem>
							<MenuItem style={{ fontSize: 14 }} value={false} classes={{ selected: classes.selected }}>
				...
				{(featureType === "Polygon" || mode === "draw_polygon") && (
					<Fragment>
						...
						<TransparencySlider transparency={transparency} setData={setData("transparency")} dir={dir} />
				...
				{/* Error Messaging */}
				{error && (
					<Typography style={{ padding: "0px 12px" }} color="error" variant="caption">
						{error}
					</Typography>
				)}
			</div>
