...
const LayerSources = (props) => {
	...
	return (
		<Fragment>
			...
			<Layer id="---ac2-gis-multilinestrings-position-end" before="---ac2-gis-linestrings-position-end" type="symbol" />
			<Layer id="---ac2-weather-position-end" before="---ac2-gis-multilinestrings-position-end" type="symbol" />
