	...
	const renderProfile = mode => {
		switch (mode) {
			...
			case "accessPoint":
				return (
					<ErrorBoundary>
						<AccessPointProfile  {...accessPointProfileActions} widgetsExpandable={true} widgetsLaunchable={true} />
					</ErrorBoundary>
				);
			default:
				break;
						...
						{tab === "events" && (
							<div style={{ height: `calc(100vh - ${WavCamOpen ? "332px" : "96px"})` }} className="events-list-wrapper">
								<div className="button-create-new">
									<Fab disabled={!canManage} onClick={handleCreateEvent} color="primary" size="small">
										<Add style={{ color: "#FFF" }} />
									</Fab>
					...
					<TabPanel value={"templates"} selectedTab={tab}>
						{tab === "templates" && (
							<div style={{ height: `calc(100vh - ${WavCamOpen ? "332px" : "96px"})` }} className="templates-list-wrapper">
								<div className="button-create-new">
									<Fab disabled={!canManage} onClick={handleCreateTemplate} color="primary" size="small">
										<Add style={{ color: "#FFF" }} />
									</Fab>
