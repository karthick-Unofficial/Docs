...
import * as actionCreators from "./robotProfileActions.js";
import { appData } from "../../shared/utility/utilities";
import { RobotProfile } from "orion-components/Profiles";
import {
	collectionsSelector,
	feedInfoSelector
...
const RobotProfileContainer = connect(
	mapStateToProps,
	mapDispatchToProps
)(RobotProfile);
export default RobotProfileContainer;
