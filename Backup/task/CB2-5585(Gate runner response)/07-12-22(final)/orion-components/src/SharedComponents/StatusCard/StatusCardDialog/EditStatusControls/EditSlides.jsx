		...
		<div style={itemStyles.container}>
			...
			<div style={{ width: "70%", padding: "0 20px" }}>
				<TextField
					...
					id={`text-set-${index}`}
					variant="standard"
					label={getTranslation("global.sharedComponents.statusCard.StatusCardDialog.editSlide.fieldLabel.text")}
					value={slide.text}
			...
			{deleteDisabled
				? (
					<Tooltip title={getTranslation("global.sharedComponents.statusCard.StatusCardDialog.editSlide.fieldLabel.atleastOne")}>
