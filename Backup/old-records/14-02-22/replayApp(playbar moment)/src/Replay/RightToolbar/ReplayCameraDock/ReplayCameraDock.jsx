	...
	return (
		<ErrorBoundary>
			...
			<div style={styles.drawerHeader}>
				<p><Translate value="replay.replayCamera.replayCamera" /></p>
				<a>
					...
					{eventideEndpoint && (<ErrorBoundary>
						<div style={{ ...styles.audioContainer, cursor: cursorStyle }} onClick={audioClick}>
							...
							<div style={styles.audioContent}>
								{!audio && !loading ? (
									<p><Translate value="replay.replayCamera.loadAudio" /></p>
								) : loading ? (
									<p><Translate value="replay.replayCamera.loading" /></p>
								) : (
									<Fragment>
										{volumeMuted ? (
											<Fragment>
												...
												<p style={styles.audioText}><Translate value="replay.replayCamera.unmute" /></p>
											</Fragment>
										) : (
											<Fragment>
												<SvgIcon style={styles.audioIcon}>
												...
												<p style={styles.audioText}><Translate value="replay.replayCamera.mute" /></p>
											</Fragment>
										)}
									</Fragment>
								)}
