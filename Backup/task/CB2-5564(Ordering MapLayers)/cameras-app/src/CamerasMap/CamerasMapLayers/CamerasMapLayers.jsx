...
const MapLayerWrapper = ({ map, feedId }) => {
	let { entityLabelsVisible, roadsVisible, mapStyle } = useSelector(state => mapSettingsSelector(state));
...
const CamerasMapLayers = memo(props => {
	...
	console.log("?mapLayers", map.getStyle().layers);
			...
			{hasSource("Line") && (
				<div>
					...
					<Layer
						...
						before="ac2-unclustered-lines-dashed"
						properties={{
					...
					<Layer
						...
						before="ac2-unclustered-lines-dotted"
						properties={{
							title: entityLabelsVisible ? "{name}" : ""
						}}
					...
					<Layer
						...
						before="ac2-unclustered-polygons"
						properties={{
							title: entityLabelsVisible ? "{name}" : ""
						}}
