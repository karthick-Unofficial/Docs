...
const PlayBar = ({ startDate, endDate }) => {
	...
	return (
		<ErrorBoundary>
			<div style={{ ...styles.playBarContainer, width: secondaryOpen || secondaryExpanded ? `calc(100% - ${secondaryExpanded ? "600px" : "360px"})` : "100%" }}>
				<div style={{ textAlign: "center", width: 80, backgroundColor: "#2c2d2f" }}>
					...
					<div style={{ display: "flex", alignItems: "center", paddingLeft: 14, height: 40, paddingBottom: 10 }}>
						<IconButton onClick={(e) => updateMenuElement(e.currentTarget)} style={{ backgroundColor: "transparent", color: "white", padding: "12px 2px 12px 12px" }}>
