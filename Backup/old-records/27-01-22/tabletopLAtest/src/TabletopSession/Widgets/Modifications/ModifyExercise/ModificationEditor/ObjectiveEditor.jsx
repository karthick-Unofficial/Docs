		...
		return(
			<div style={{flex:1, marginLeft: 10, marginRight: 10}}>
				<MapObjectSelectorContainer id="result" definitionDesc={""}
					...
					required={true}
					headerText={"Choose location of Objective"}
	...
	return (
		<div>
			<div className="modificationflex">
				{
					(!isInEditMode()) && <Typography variant="body1" className="b1-white" style={{margin:10, alignSelf:"center", flex:1, fontSize:18}}>{"Add Objective"}</Typography>
				}
				{
					(isInEditMode()) && <Typography variant="body1" className="b1-white" style={{margin:10, alignSelf:"center", flex:1, fontSize:18}}>{"Edit Objective"}</Typography>
				}
				...
				<div className="modificationActionsRight">
					...
					<Button variant="contained" color="primary" disabled={disableSaveButton()} 
						style={{ width: 74, marginLeft:10, marginRight:10 }} onClick={saveObjective}>Save</Button>
				</div>
			</div>
			<div className="modificationflex">
