...
const CameraGeoMenu = ({ handleSelect, handleConfirm, entity, closeDialog, openDialog, dialog }) => {
	...
	return (
		<Fragment>
			...
			>
				{entityType == "accessPoint" && <MenuItem onClick={() => facilityEntity ? dispatch(openDialog("facilityWarningDialog")) : handleSelection("accessPoint-edit")}>
					<ListItemIcon>
						<Edit style={{ color: "#FFF" }} />
					</ListItemIcon>
					<ListItemText primary={getTranslation("accessPointMapLayers.listItemText.editLocation")} />
				</MenuItem>}
				{entityType == "camera" && <MenuItem onClick={() => facilityEntity ? dispatch(openDialog("facilityWarningDialog")) : handleSelection("camera-edit")}>
					<ListItemIcon>
						<Edit style={{ color: "#FFF" }} />
					</ListItemIcon>
