...
const RULE_OPTIONS = [
	{
		label: <Translate value="main.mainJsx.rulesOptions.label.trackMovement"/>,
		value: "track-movement"
	},
	{
		label: <Translate value="main.mainJsx.rulesOptions.label.vesselEventRule"/>,
		value: "vessel-event",
		condition: "canCreateVesselEventRule"
	},
	{
		label: <Translate value="main.mainJsx.rulesOptions.label.alarmRule"/>,
		value: "alarm"
	},
	{
		label: <Translate value="main.mainJsx.rulesOptions.label.eventCreated"/>,
		value: "create-event"
	}
];
...
class Main extends Component {
	...
	render() {
		...
		const actions = [
			<FlatButton label={<Translate value="main.mainJsx.actions.label.cancel"/>} primary={true} onClick={this._handleClose} />,
			<FlatButton
				label={<Translate value="main.mainJsx.actions.label.delete"/>}
				primary={true}
		...
		const createButton = (
			<div>
				<RaisedButton
					label={<Translate value="main.mainJsx.createButton.createNewRule"/>}
					secondary={true}
		...
		const createButtonMobile = (
			<div>
				...
				>
					<Menu>
						<MenuItem
							primaryText={<Translate value="main.mainJsx.rulesOptions.label.trackMovement"/>}
							onClick={() => this._goCreate("track-movement")}
						/>
						{this.props.canCreateVesselEventRule && <MenuItem
							primaryText={<Translate value="main.mainJsx.rulesOptions.label.vesselEventRule"/>}
		...
		return (
			<div className="rules-wrapper-home">
				<div className="rules-filters">
					...
					<ListItem
						key={"trigger-list"}
						primaryText={<Translate value="main.mainJsx.rulesFilters.listItem.triggerList.primaryText"/>}
						style={{
							fontSize: 12
						}}
						nestedListStyle={{
						...
						nestedItems={[
							<Checkbox
								key={1}
								label={<Translate value="main.mainJsx.rulesFilters.listItem.triggerList.nestedItems.checkbox.label.cross"/>}
							...
							/>,
							<Checkbox
								label={<Translate value="main.mainJsx.rulesFilters.listItem.triggerList.nestedItems.checkbox.label.enter"/>}
								key={2}
							...
							<Checkbox
								key={3}
								label={<Translate value="main.mainJsx.rulesFilters.listItem.triggerList.nestedItems.checkbox.label.exit"/>}
							...
							<Checkbox
								key={4}
								label={<Translate value="main.mainJsx.rulesFilters.listItem.triggerList.nestedItems.checkbox.label.loiter"/>}
							...
							<Checkbox
								key={5}
								label={<Translate value="main.mainJsx.rulesFilters.listItem.triggerList.nestedItems.checkbox.label.newRequest"/>}
							...
							<Checkbox
								key={6}
								label={<Translate value="main.mainJsx.rulesFilters.listItem.triggerList.nestedItems.checkbox.label.requestApproval"/>}
							...
							<Checkbox
								key={7}
								label={<Translate value="main.mainJsx.rulesFilters.listItem.triggerList.nestedItems.checkbox.label.berthUpdates"/>}
							...
							<Checkbox
								key={8}
								label={<Translate value="main.mainJsx.rulesFilters.listItem.triggerList.nestedItems.checkbox.label.arrivals"/>}
							...
							<Checkbox
								key={9}
								label={<Translate value="main.mainJsx.rulesFilters.listItem.triggerList.nestedItems.checkbox.label.departures"/>}
							...
							<Checkbox
								key={10}
								label={<Translate value="main.mainJsx.rulesFilters.listItem.triggerList.nestedItems.checkbox.label.securityViolations"/>}
					...
					<ListItem
						key={"createdby"}
						primaryText={<Translate value="main.mainJsx.rulesFilters.listItem.createdby.primaryText"/>}
						style={{
							padding: 0,
							fontSize: 12
						}}
				...
				<div className="rules-areas">
						...
						<div className="row-item fullwidth">
							<ErrorBoundary>
								<TypeAheadFilterContainer
									...
									placeholder={this.placeholderConverter("main.mainJsx.rulesFilters.rulesAreas.TypeAheadFilterContainer.placeholder")}
								/>
							</ErrorBoundary>
						</div>
						<div className="row-item fullwidth">
					...
					<div className="rulesSectionWrapper">
						<h3 className="rulesSectionTitle">
							{numMyRules === 1 ? "rule" : "rules"}<Translate value="main.mainJsx.rulesFilters.rulesAreas.rulesSectionWrapper.rulesSectionTitle" count={numMyRules}/>({numMyRules})
						</h3>
					...
					<div className="rulesSectionWrapper">
						<h3 className="rulesSectionTitle">
							{numSharedRules === 1 ? <Translate value="main.mainJsx.rulesFilters.rulesAreas.rulesSectionWrapper.ruleShared" count={numSharedRules}/> : <Translate value="main.mainJsx.rulesFilters.rulesAreas.rulesSectionWrapper.ruleShared" count={numSharedRules}/>}
						</h3>
						<div className="row rulesContainer">
							{numSharedRules === 0 ? (
								<p>
				...
				<Dialog
					...
					title={<Translate value="main.mainJsx.rulesFilters.dialog.title"/>}
					actions={actions}
					modal={false}
