								...
								<div className="rule-attribute-row last-row">
									...
									<ErrorBoundary>
										<GenericAttribute
											...
											inputType={"dropdown"}
											inputOptions={[
												{value: "berth-assignment-created", label: <Translate value="createEditRule.vesselEvents.newReq"/>},
												{value: "berth-assignment-approval", label: <Translate value="createEditRule.vesselEvents.requestApproval"/>},
												{value: "berth-assignment-update", label: <Translate value="createEditRule.vesselEvents.berthUpdates"/>},
												{value: "arrival", label: <Translate value="createEditRule.vesselEvents.arrivals"/>},
												{value: "departure", label: <Translate value="createEditRule.vesselEvents.departures"/>},
												{value: "berth-security-violation", label: <Translate value="createEditRule.vesselEvents.secViolation"/>}
											]}
