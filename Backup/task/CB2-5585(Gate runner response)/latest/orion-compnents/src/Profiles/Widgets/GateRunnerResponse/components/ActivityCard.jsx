...
const ActivityCard = ({
    ...
    const styles = {
        ...
        gate: {
            ...(selectedDetection ? { fontSize: 15 } : { fontSize: 12 }),
            color: "#fff",
            lineHeight: "unset",
        ...
        <>
            ...
            >
                ...
                <div style={styles.selectedGateWrapper}>
                    <Typography style={{ fontSize: "12px", color: "#fff", lineHeight: "unset", paddingBottom: "10px", textTransform: "uppercase" }}>{selectedDetection.CameraName}</Typography>
                    ...
                    <ElapsedTimer CaptureDateTime={selectedDetection.CaptureDateTime} />
                </div>
            </ListItem>
        </>
        :
