...
const VesselEvent = ({ getAllBerths, editMode, updateRule, removeContext, rules, params, title, desc, audioSettings, dismissForOrg, user, addRule, updateTitleErrorMessage, validateAudioSettings, assignments, berths, entityCollections, timeFormatPreference, dir, isOpen, openDialog, closeDialog }) => {
