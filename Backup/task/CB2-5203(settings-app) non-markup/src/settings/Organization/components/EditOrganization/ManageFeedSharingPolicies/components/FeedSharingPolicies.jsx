...
const handlePolicyUpdate = (savePolicies, selectedIntegration, orgId, policies) => e => {
...
const handleCheckUnlimited = (orgId, feedId, newPolicies, savePolicies) => {
...
const handleAllowedPermissionsUpdate = (permission, checked, orgId, feedId, newPolicies, savePolicies) => {
...
const handleDeactivateAll = (selectedIntegration, policies, savePolicies) => {
...
const handleStartDateChange = (date, orgId, feedId, policies, updateNewPolicies, updateErrorState, savePolicies) => {
	if (policies[orgId].type === "always" ? policies[orgId].alwaysShared.endDate : policies[orgId].eventSharingOnly.endDate) {
		...
		if (endDate.isBefore(date)) {
			updateErrorState({
				startDatePickerError: getTranslation("mainContent.manageOrganization.orgSettings.manageFeedSharing.policies.startDatePickerError"),
				endDatePickerError: ""
			});
			 updateNewPolicies({
				 ...policies,
...
const handleEndDateChange = (date, orgId, feedId, policies, updateNewPolicies, updateErrorState, savePolicies) => {
	...
	if (policies[orgId].type === "always" ? policies[orgId].alwaysShared.startDate : policies[orgId].eventSharingOnly.startDate) {
		...
		if (startDate.isAfter(date)) {
			updateErrorState({
				startDatePickerError: "",
				endDatePickerError: getTranslation("mainContent.manageOrganization.orgSettings.manageFeedSharing.policies.endDatePickerError")
			});
			updateNewPolicies({
				...policies,
				[orgId]: {
...
const FeedSharingPolicies = ({
	...
	return (
		<EditPageTemplate
			title={getTranslation("mainContent.manageOrganization.orgSettings.manageFeedSharing.title")}
				...
				<header style={{marginBottom: 24}}>
					<div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
						...
						<Button style={{ textTransform: "none", fontSize: 12, color: "#4eb5f3"}} 
							onClick={() => handleDeactivateAll(chosenIntegration, newPolicies, savePolicies)}
						>
											...
											<Fragment>
												{
													newPolicies[org.orgId] && (
														<ListItemText
															...
															getTranslation("mainContent.manageOrganization.orgSettings.manageFeedSharing.policies.alwaysHaveAccess")
																:
																newPolicies[org.orgId].type === "never-shared" ?
																	""
																	:
																	getTranslation("mainContent.manageOrganization.orgSettings.manageFeedSharing.policies.onlyWhenAdded")}
														/>
													)
												}
											</Fragment>
												...
												<div style={dir === "rtl" ? {
													...
													<FormControl component="fieldset" style={dir == "rtl" ? {flexDirection: "row-reverse"}: {}}>
														<RadioGroup
															...
															onChange={handlePolicyUpdate(savePolicies, chosenIntegration, org.orgId, newPolicies)}
														>
															<FormControlLabel
																style={dir == "rtl" ? {
																	marginLeft: 50
																...
																label={getTranslation("mainContent.manageOrganization.orgSettings.manageFeedSharing.radioLabel.never")}
															/>
															<FormControlLabel
																style={dir == "rtl" ? {
																	marginLeft: 50
																...
																label={getTranslation("mainContent.manageOrganization.orgSettings.manageFeedSharing.radioLabel.always")}
															/>
															<FormControlLabel
																style={dir == "rtl" ? {
																	marginLeft: 50
																...
																label={getTranslation("mainContent.manageOrganization.orgSettings.manageFeedSharing.radioLabel.event")}
															/>
														</RadioGroup>
													</FormControl>
															...
															<div style={{ display: "flex", alignItems: "baseline" }}>
																<div style={dir == "rtl" ? { marginLeft: 45 } : { marginRight: 45 }}>
																	<FormControlLabel
																		control={
																			<Checkbox
																				color="primary"
																				onChange={() => handleCheckUnlimited(org.orgId, chosenIntegration.feedId, newPolicies, savePolicies)}
																				checked={
																		...
																		label={getTranslation("mainContent.manageOrganization.orgSettings.manageFeedSharing.radioLabel.unlimited")}
																...
																<div style={{ display: "flex", alignItems: "baseline" }}>
																	<DatePicker
																		...
																		fullWidth={false}
																		handleChange={(date) => {
																			handleStartDateChange(date, org.orgId, chosenIntegration.feedId, newPolicies, updateNewPolicies, updateErrorState, savePolicies);
																		}}
																		options={{
																	...
																	<DatePicker
																		...
																		fullWidth={false}
																		handleChange={(date) => {
																			handleEndDateChange(date, org.orgId, chosenIntegration.feedId, newPolicies, updateNewPolicies, updateErrorState, savePolicies);
																		}}
																		options={{
																				...
																				<FormControlLabel
																					...
																					control={
																						<Checkbox
																							...
																							color="primary"
																							onChange={(e, checked) => {
																								handleAllowedPermissionsUpdate(permission, checked, org.orgId, chosenIntegration.feedId, newPolicies, savePolicies);
																							}}
																						/>
																					}
