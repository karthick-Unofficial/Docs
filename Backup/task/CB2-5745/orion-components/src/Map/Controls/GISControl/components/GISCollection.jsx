									...
									<ListItem key={layer.id}>
										...
										>
											<Switch
												...
												} // Layers are stored in state with a unique ID from service and layer ID
												onChange={(e) =>
													handleToggle(
														service.id,
														layer.id,
				...
				<ListItem key={id} disableGutters>
					...
					>
						<Switch
							...
							onChange={(e) =>
								handleToggle(service.id, id, e.target.checked)
							}
							classes={{
								thumb:
									!serviceState[`${service.id}-${id}`] &&
									classes.thumbOff,
								track:
									!serviceState[`${service.id}-${id}`] &&
									classes.trackOff
