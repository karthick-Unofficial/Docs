...
const GISDialog = ({ success, resetRequest, handleClose, createService, open, error, isFetching, dir }) => {
	...
	return (
		<Dialog
			...
			confirm={{
				label: error
					? getTranslation("global.map.controls.gisControl.gisDialog.retry")
					: getTranslation("global.map.controls.gisControl.gisDialog.add"),
				action: handleSave,
				disabled:
					!newService.name ||
					!newService.url ||
