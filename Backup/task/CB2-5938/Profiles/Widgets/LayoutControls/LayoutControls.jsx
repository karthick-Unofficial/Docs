...
const getWidgetName = (id) => {
	switch (id) {
		...
		case "activities":
			return getTranslation("global.profiles.layoutControls.activityTimeLine");
		case "live_camera":
...
const LayoutControls = ({ widgetOrder, close, expandedWidget, profile }) => {
	const dispatch = useDispatch();
	const dir = useSelector((state) => getDir(state));
	const widgetState = useSelector((state) => getGlobalWidgetState(state)("layoutControls")) || {};
