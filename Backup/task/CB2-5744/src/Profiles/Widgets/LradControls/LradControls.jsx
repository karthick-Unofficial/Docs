...
const LradControls = ({ camera, dir }) => {
	...
	const styles = {
		playAudioSelectContainer: {
			display: "flex",
			flexDirection: "column",
			minWidth: 250,
			...(dir === "rtl" && { paddingLeft: 10 }),
			...(dir === "ltr" && { paddingRight: 10 })
		},
	...
	return (
		<div>
			<h5>
				<Translate value="global.profiles.widgets.lradControls.title" />
			</h5>
			<div style={{ display: "flex" }}>
				<div style={styles.playAudioSelectContainer}>
					<SelectField
						id="playAudioSelect"
						label={getTranslation(
							"global.profiles.widgets.lradControls.playAudio"
						)}
						handleChange={(e) =>
						...
						>
							...
							<div style={styles.volumeSliderContainer}>
								<div className="b2-bright-gray">
									<Translate value="global.profiles.widgets.lradControls.volume" />
								</div>
								<Slider
									value={tempVolume}
									min={0}
				...
				>
					<FormControlLabel
						...
						label={getTranslation(
							"global.profiles.widgets.lradControls.beam"
						)}
					/>
					<FormControlLabel
						control={
						...
						label={getTranslation(
							"global.profiles.widgets.lradControls.strobe"
						)}
					/>
				</div>
			</div>
