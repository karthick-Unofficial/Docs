...
const BerthRequestForm = ({
	...
	const checkSubmit = () => {
		...
		const agentValid = agent.name && agent.email && !agentEmailError;
		/*
		...
		const requestedByValid = requestingCompanyDisabled || !(!requested.name || !requested.email || requestedEmailError);
			...
			<div style={styles.main}>
				...
				<div style={styles.flex}>
					...
					{cargoDirectionLevel !== "cargo" && (
						<div style={dir == "rtl" ? { width: "100%", margin: "20px 20px 0px 0px" } : { width: "100%", margin: "20px 0px 0px 20px" }}>
					...
					<div style={{ width: width < 1600 ? "100%" : "22%", margin: "20px" }}>
						<FormControl margin="normal" fullWidth>
							<InputLabel style={dir && dir == "rtl" ? { left: "unset", transformOrigin: "top right" } : {}}><Translate value="berthRequestForm.main.fieldLabel.vesselType" /></InputLabel>
							<Select
					...
					<div style={{ width: width < 1600 ? "100%" : "22%", margin: "20px" }}>
						<FormControl fullWidth>
							<InputLabel style={dir && dir == "rtl" ? { left: "unset", transformOrigin: "top right" } : {}}><Translate value="berthRequestForm.main.fieldLabel.primaryActivity" /></InputLabel>
							<Select
					...
					<div style={{ width: "100%", margin: "20px" }}>
						<FormControl margin="normal" fullWidth>
							<InputLabel style={dir && dir == "rtl" ? { left: "unset", transformOrigin: "top right" } : {}}><Translate value="berthRequestForm.main.fieldLabel.berthName" /></InputLabel>
							<Select
					...
					<div style={dir == "rtl" ? { margin: "35px auto 35px 35px" } : { margin: "35px 35px 35px auto" }}>
						<Button
							variant="contained"
							color="primary"
							disabled={!formValid}
