...
const FullscreenVideoModal = ({
	...
	return (
		<Dialog fullScreen key={dialogKey} open={dialog === dialogKey} PaperProps={{ style: { backgroundColor: "rgb(44, 45, 47)" } }}>
			<div style={styles.header}>
				<Typography
					style={dir == "rtl" ? { paddingRight: 12, color: "#fff" } : { paddingLeft: 12, color: "#fff" }}
					color="textPrimary"
					variant="subtitle1"
				>
