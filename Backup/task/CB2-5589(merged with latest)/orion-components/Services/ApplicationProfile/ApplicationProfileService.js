...
var ApplicationProfileService = function ApplicationProfileService(_ref) {
  var setReady = _ref.setReady;
  var dispatch = (0, _reactRedux.useDispatch)();
  var getApplicationProfile = actionCreators.getApplicationProfile;
  (0, _react.useEffect)(function () {
    dispatch(getApplicationProfile(setReady));
  }, []);
  return /*#__PURE__*/_react["default"].createElement(_react.Fragment, null);
};
var _default = ApplicationProfileService;
