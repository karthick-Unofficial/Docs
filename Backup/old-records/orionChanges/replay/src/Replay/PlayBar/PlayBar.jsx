			...
			<div style={{
				...
				<div style={{ textAlign: "center", width: 80, backgroundColor: "#2c2d2f" }}>
					...
					<div style={{display: "flex", alignItems: "center", paddingLeft: 14, height: 40, paddingBottom: 10}}>
						...
						<p style={{color: "white", fontSize: 12}}>{playSpeed}x</p>
						<Menu
							id="play-speed"
				...
				<div style={{ 
					...
					paddingRight: 25
					 ...
					 <div style={{height: 19, marginBottom: 10, marginTop: 10}}>
						<div style={{float: "left", color: "white"}}>{moment(startDate).format("h:mm A")}</div>
						 <div style={{float: "right", color: "white"}}>{moment(endDate).format("h:mm A")}</div>
					 </div>
					<Slider
						classes={{
							root: classes.root,
						...
						valueLabelFormat={(x) => moment(x).format("h:mm:ss A")}
