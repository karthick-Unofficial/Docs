...
const GenericDetailsWidget = ({ kvPairs, displayProps }) => {
...
const onPropsChange = (prevProps, nextProps) => {
	if (
		!_(prevProps.kvPairs).xorWith(nextProps.kvPairs, isEqual).isEmpty() ||
		!prevProps.displayProps.isEqual(nextProps.displayProps)
	) {
		return false;
	}
	return true;
