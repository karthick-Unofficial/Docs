...
const CameraSlot = ({ user, camera, length, isEmpty, gridHeight, sendMessage }) => {

	const emptySlot = <div style={{
		...styles.emptySlot,
		height: gridHeight ? gridHeight : ""
	}} />;

	const canControlCamera = !!(user.integrations && camera
		...
		isEmpty
			...
			: <Card style={{
				...
				<CardActions style={styles.cardActions}>
					<p style={{ marginLeft: "10px" }}>{camera.entityData.properties.name}</p>
					<Button
