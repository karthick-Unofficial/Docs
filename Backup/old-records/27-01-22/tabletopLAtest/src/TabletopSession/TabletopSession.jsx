...
const TabletopSession = ( { 
	...
	return isHydrated && sessionId ? (
		<ErrorBoundary componentName="tabletopSession">
			...
			<div className="tabletopHeader" style={dir == "rtl" ? {right: `${leftDockWidth}px`, left: `${rightDockWidth}px`} : {left: `${leftDockWidth}px`, right: `${rightDockWidth}px`}}>
				<ErrorBoundary componentName="SimulationTreeContainer">
					<SimulationTreeContainer docksWidth={leftDockWidth + rightDockWidth} />
					<UserBannerContainer />
				</ErrorBoundary>
			</div>
			<div className="playbackContainer" style={dir == "rtl" ? {right: `${leftDockWidth}px`, left: `${rightDockWidth}px`} : {left: `${leftDockWidth}px`, right: `${rightDockWidth}px`}}>
				<ErrorBoundary componentName="PlaybackContainer">
					<PlaybackContainer reportPlaybackHeight={setPlaybackHeight} dir={dir}/>
				</ErrorBoundary>
			</div>
