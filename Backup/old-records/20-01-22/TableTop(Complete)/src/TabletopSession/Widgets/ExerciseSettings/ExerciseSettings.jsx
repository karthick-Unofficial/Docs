		...
		<div className="exerciseSettingsContainer">
			<div className="row">
				<SelectField
					...
					label={<Translate value="tableopSession.widgets.excerciseSettings.simMode"/>}
					value={simulationMode}
					handleChange={(e) => setSimulationMode(sessionId, e.target.value)}
					items={[
						{ value: "simulation", id: "simulation", name: <Translate value="tableopSession.widgets.excerciseSettings.simulation"/>},
						{ value: "playback", id: "playback", name: <Translate value="tableopSession.widgets.excerciseSettings.playback"/> }
					]}
				...
				<SelectField
					...
					label={<Translate value="tableopSession.widgets.excerciseSettings.controller"/>}
					value={controller}
			...
			<div className="row">
				{(user.id === controller) &&
					<div className="" style={{ width: "100%", marginRight: 51 }}>
						<SelectField
							...
							label={<Translate value="tableopSession.widgets.excerciseSettings.modifySim"/>}
				...
				<div  className={user.id === controller ? "leftSpacing": "noSpacing"} >
					<SelectField
						id="timePrecision"
						label={<Translate value="tableopSession.widgets.excerciseSettings.simTimePrecision"/>}
			...
			{(user.id === controller) &&
				<div className="row" style={{marginLeft: -10, marginTop: 15}}>
					...
					/>
					<Typography variant="body1" className="b1-white"><Translate value="tableopSession.widgets.excerciseSettings.enableWeaponFire"/></Typography>
				</div>
			}
			<div style={{ marginTop: 72 }}>
				<div className="b1-white"><Translate value="tableopSession.widgets.excerciseSettings.mapDisplaySett"/></div>
				<div className="b2-bright-gray" style={{ marginTop: 34 }}><Translate value="tableopSession.widgets.excerciseSettings.setTraceDisplay"/></div>
				<Slider
					value={traceDuration}
					min={0}
					max={120}
			...
			<div className="b1-white" style={{ marginTop: 66 }}><Translate value="tableopSession.widgets.excerciseSettings.mapSymbolSize"/></div>
			...
			<div className="symbolSizer">
				<div className="b2-bright-gray">
				<Translate value="tableopSession.widgets.excerciseSettings.mapMarkers"/>
				</div>
				<Slider
			...
			<div className="symbolSizer">
				<div className="b2-bright-gray"><Translate value="tableopSession.widgets.excerciseSettings.events"/></div>
				<Slider
