		...
		<Fragment>
			{
				map(facilityFeeds, feedId =>
					<Fragment key={`${feedId}`}>
						<FacilitiesLayerWrapper key={`${feedId}_layer`} feedId={feedId} before="---ac2-feed-entities-position-end" />
						<ActiveFloorPlans key={`${feedId}_floorplans`} feedId={feedId} before="---ac2-floorplans-position-end" />
					</Fragment>
				)
			}
		</Fragment>
