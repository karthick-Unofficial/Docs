...
import { Activities, FileWidget, LinkedItemsWidget, PhoenixDropzone, LiveCameraWidget } from "orion-components/Profiles/Widgets";
...
const CameraView = ({
	...
	camera = isLoaded && entity;
	contextId = isLoaded && entity.id;
	...
	fromOrg = isLoaded && ownerOrg === orgId;
	fromEco = isLoaded && ownerOrg !== orgId;
