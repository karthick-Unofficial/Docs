...
export const getIcon = (type, fontSize = "2rem", icon = null) => {
	if (!icon) {
		switch (type) {
			...
			case "accessPoint":
			case "AccessPoint":
				icon = <SvgIcon style={{ width: 34, height: 34 }}><path d={mdiAccessPoint} /></SvgIcon>;
				break;
			case "Zetron":
			...
			case "Ghost Robotics Dog":
				...
				break;
			case "drone":
				icon = <SvgIcon style={{ width: 34, height: 34 }}><path d={mdiQuadcopter} /></SvgIcon>;
				break;
			case "drone-controller":
				icon = <SvgIcon style={{ width: 44, height: 44 }}><path d={mdiGoogleController} /></SvgIcon>;
				break;
			case "drone-home":
				icon = <SvgIcon style={{ width: 34, height: 34 }}><path d={mdiHome} /></SvgIcon>;
				break;
			default:
				break;
		}
