...
const imageAttachmentsSelector = createSelector([getAttachments], (attachments) => {
	const imageAttachments = attachments?.filter((attachment) => attachment.mimeType.includes("image/png")) || [];
...
const otherAttachmentsSelector = createSelector([getAttachments], (attachments) => {
	const otherAttachments = attachments?.filter((attachment) => !attachment.mimeType.includes("image/png")) || [];
