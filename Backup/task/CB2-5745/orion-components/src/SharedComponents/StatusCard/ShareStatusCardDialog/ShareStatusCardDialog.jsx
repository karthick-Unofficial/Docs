		...
		<Dialog
			...
			confirm={{
				label: getTranslation(
					"global.sharedComponents.statusCard.shareStatusCardDialog.save"
				),
				action: () => save()
			}}
			abort={{
				label: getTranslation(
					"global.sharedComponents.statusCard.shareStatusCardDialog.cancel"
				),
				action: () => cancel()
			}}
			title={getTranslation(
				"global.sharedComponents.statusCard.shareStatusCardDialog.title"
			)}
			options={{
				maxWidth: "xs",
				fullWidth: true
