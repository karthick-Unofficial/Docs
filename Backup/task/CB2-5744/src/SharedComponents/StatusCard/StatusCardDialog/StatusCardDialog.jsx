	...
	return (
		<Dialog
			...
			confirm={{
				label: getTranslation(
					"global.sharedComponents.statusCard.StatusCardDialog.save"
				),
				action: () => save()
			}}
			abort={{
				label: getTranslation(
					"global.sharedComponents.statusCard.StatusCardDialog.cancel"
				),
				action: () => cancel()
			}}
			deletion={{
				label: getTranslation(
					"global.sharedComponents.statusCard.StatusCardDialog.delete"
				),
				action: () => deleteCard()
			}}
			options={{
		...
		>
			<div style={{ minHeight: "500px" }}>
				<TextField
					label={getTranslation(
						"global.sharedComponents.statusCard.StatusCardDialog.fieldLabel.cardName"
					)}
					fullWidth={true}
					margin="normal"
					value={cardName}
				...
				<FormControlLabel
					...
					label={getTranslation(
						"global.sharedComponents.statusCard.StatusCardDialog.global"
					)}
