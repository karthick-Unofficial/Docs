...
const FloorPlan = (props) => {
	...
	const { image, id, editing, feedId, before } = props;
	...
	const imgSrc = image ? image : floorPlan && floorPlan.image ? typeof floorPlan.image === "string" ? floorPlan.image : URL.createObjectURL(floorPlan.image) : "";
