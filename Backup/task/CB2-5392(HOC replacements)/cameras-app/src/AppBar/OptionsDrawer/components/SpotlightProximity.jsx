			...
			<div style={{ display: "flex", alignItems: "flex-start" }}>
				<FormControl error={!!error}>
					...
					<Input
						...
						endAdornment={<InputAdornment>{outputUnit == "km" ? getTranslation("appBar.optionDrawer.spotlightProx.km") : getTranslation("appBar.optionDrawer.spotlightProx.mi")}</InputAdornment>}
					/>
