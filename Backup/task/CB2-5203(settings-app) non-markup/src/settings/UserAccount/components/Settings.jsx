...
import { Voice, RulerSquareCompass, History, ClockCheckOutline, Web } from "mdi-material-ui";
import { timeConversion } from "client-app-core";
// Components
import ArticleContainer from "../../shared/components/ArticleContainer";

import { Translate, getTranslation } from "orion-components/i18n/I18nContainer";
import { supportedLocales } from "orion-components/i18n/I18nContainer";
...
const handleSettingsUpdate = (setting, updateUserAppSettings, globalState, setlocale) => e => {
	...
	updateUserAppSettings(newGlobalState);
};
...
const Settings = ({
	...
	const twelveHourFormat = timeConversion.convertToUserTime(currentTime, "full_12-hour");
	const twentyFourHourFormat = timeConversion.convertToUserTime(currentTime, "full_24-hour");
	...
	return (
		<ArticleContainer
			...
			dir={dir}
		>
			<section style={dir == "rtl" ? { ...styles.sectionRTL, marginTop: 30, marginBottom: 115 } : {
				...styles.section,
				marginTop: 30,
				marginBottom: 115
			}}>
				<div style={dir == "rtl" ? styles.rightText : { ...styles.leftText, display: "flex" }}>
					<Voice style={dir == "rtl" ? styles.iconsRTL : styles.icons} />
				...
				<FormControl component="fieldset">
					<RadioGroup
						...
						onChange={handleSettingsUpdate("tts", updateGlobalUserAppSettings)}
					>
			...
			<section style={dir == "rtl" ? { ...styles.sectionRTL, marginTop: 20, marginBottom: 20 } : { ...styles.section, marginTop: 20, marginBottom: 20 }}>
				<div style={dir == "rtl" ? styles.rightText : { ...styles.leftText, display: "flex" }}>
					<History style={dir == "rtl" ? styles.iconsRTL : styles.icons} />
					<div style={{ marginTop: 25 }}>
				...
				<div style={{ width: 280 }}>
					<SelectField
						...
						handleChange={handleSettingsUpdate("trackHistory", updateGlobalUserAppSettings, globalState)}
			...
			<Divider style={{ position: "absolute", left: 24, right: 24 }} />
			<section style={dir == "rtl" ? { ...styles.sectionRTL, marginBottom: 175, marginTop: 25 } : {
				...styles.section,
				marginBottom: 175,
				marginTop: 25
			}}>
				<div style={dir == "rtl" ? styles.rightText : { ...styles.leftText, display: "flex" }}>
					<RulerSquareCompass style={dir == "rtl" ? styles.iconsRTL : styles.icons} />
					<div style={{ marginTop: 25 }}>
				...
				<div style={{
					...
					<div style={{
						...
						<SelectField
							...
							handleChange={handleSettingsUpdate("coordinateSystem", updateGlobalUserAppSettings, globalState)}
						...
						<div style={{ marginTop: 30 }}>
							<SelectField
								...
								handleChange={handleSettingsUpdate("landUnitSystem", updateGlobalUserAppSettings, globalState)}
			...
			<section style={dir == "rtl" ? { ...styles.sectionRTL, marginTop: 30, marginBottom: 115 } : {
				...
				<div style={dir == "rtl" ? styles.rightText : { ...styles.leftText, display: "flex" }}>
					<ClockCheckOutline style={dir == "rtl" ? styles.iconsRTL : styles.icons} />
					<div style={{ marginTop: 25 }}>
				...
				<FormControl component="fieldset">
					<RadioGroup
						...
						onChange={handleSettingsUpdate("timeFormat", updateGlobalUserAppSettings, globalState)}
					>
						<label style={styles.formLabel}>
			...
			<Divider style={{ position: "absolute", left: 24, right: 24 }} />
			<section style={dir == "rtl" ? { ...styles.sectionRTL, marginTop: 30, marginBottom: 50 } : {
				...styles.section,
				marginTop: 30,
				marginBottom: 50
			}}>
				<div style={dir == "rtl" ? styles.rightText : { ...styles.leftText, display: "flex" }}>
					<Web style={dir == "rtl" ? styles.iconsRTL : styles.icons} />
					<div style={{ marginTop: 25 }}>
				...
				<div style={{
					...
					<div style={{
						...
						<SelectField
							...
							value={locale}
							handleChange={handleSettingsUpdate("locale", updateGlobalUserAppSettings, globalState, setLocaleWithFallback)}
