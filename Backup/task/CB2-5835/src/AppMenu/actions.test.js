...
import { checkMockedUrl, flushAllPromises, getMockedMethod, safelyMock } from "../lib/test-utils.js";
...
describe("ListPanel Async Actions", () => {
	describe("hydrateUser", () => {
		...
		it("Should dispatch HYDRATE_USER_SUCCESS on success", () => {
			...
			const expectedActions = [{ type: t.HYDRATE_USER_SUCCESS, user: response.user }];
