...
const replayTypes = [
	{
		title: <Translate value="newReplay.replay.title" />,
		description: <Translate value="newReplay.replay.description" />,
					...
					<div>
						...
						<Container component={"section"} style={{
							...
							<section style={styles.replayTypesSection}>
								...
								<img src={require("../../public/static/images/zone-replay-coming-soon.png")} style={locale === "en" ? styles.placeholderImg : styles.placeholderImgAr} />
								<img src={require("../../public/static/images/track-replay-coming-soon.png")} style={locale === "en" ? styles.placeholderImg : styles.placeholderImgAr} />
								<img src={require("../../public/static/images/event-replay-coming-soon.png")} style={locale === "en" ? styles.placeholderImg : styles.placeholderImgAr} />
							</section>
						</Container>
