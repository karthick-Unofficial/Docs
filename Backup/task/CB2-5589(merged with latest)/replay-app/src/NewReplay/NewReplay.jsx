		...
		setReplayTypes([
			{
				...
				icon: (
					<SvgIcon style={styles.newReplayIcons}>
					...
					<div>
						...
						>
							<section style={styles.replayTypesSection}>
								...
								<img
									src={require("../shared/images/zone-replay-coming-soon.png")}
									style={locale === "en" ? styles.placeholderImg : styles.placeholderImgAr}
								/>
								<img
									src={require("../shared/images/track-replay-coming-soon.png")}
									style={locale === "en" ? styles.placeholderImg : styles.placeholderImgAr}
								/>
								<img
									src={require("../shared/images/event-replay-coming-soon.png")}
									style={locale === "en" ? styles.placeholderImg : styles.placeholderImgAr}
								/>
							</section>
						</Container>
