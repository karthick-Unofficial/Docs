...
import { Avatar, List, ListItem, ListItemIcon, ListItemSecondaryAction, ListItemText, CircularProgress, Divider, Switch } from "@material-ui/core";
...
const handleSubmit = (e, user, ecoIntegrations, values, checked, intName, intId, orgIntId, updateIntegration, updateValues) =>{
