...
import { contextPanelState, mapFiltersSelector } from "orion-components/ContextPanel/Selectors";
	...
	const handleUpdateBounds = () => {
		...
		if (filterItems.length) {
			const features = filterItems
				...
				.map(data => {
					let geometry;
					const type = filters[data.properties.id].entityType === "accessPoint" ? filters[data.properties.id].entityType : data.properties.type;
