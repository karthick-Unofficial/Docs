...
const BerthForm = (props) => {
	...
	const styles = {
		...
		inputLabelProps: {
			...(dir && dir == "rtl" ? { transformOrigin: "top right", textAlign: "right", right: 0 } : { transformOrigin: "top left", right: "unset" }),
		}
	};
							...
							{!!berthData.length && canManage ? (
								<TableHead style={{ borderBottom: "none" }} >
									<TableRow style={{ height: "auto" }}>
										...
										<TableCell style={{ textAlign: "unset", padding: "4px 0px 4px 12px", color: "#fff" }}>
