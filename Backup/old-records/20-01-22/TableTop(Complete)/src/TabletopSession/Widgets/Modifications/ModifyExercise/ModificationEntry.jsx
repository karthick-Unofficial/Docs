	...
	return (entities && entities.length>0) ? (
		<div className="modificationItemContainer" style={{marginTop:10, marginBottom:10, minHeight:70, width: "98%"}}>
					...
					style={{textAlign:"left", textDecoration:(mode === "REJECTED")? "line-through": "none"}}>{description}</Typography>
				{
					...
					<div className="modificationCommentsField">
						<TextField
							...
							placeholder={placeholderConverter("tableopSession.widgets.modifications.modificationEntry.addComment")}
							multiline={false}
			...
			<div className="" style={{margin:5, alignSelf: "center"}}>
				{ /* PENDING Button */
					!isController && (mode === "SUBMITTED" || mode === "RESUBMITTED") && <Typography variant="body1" className="b2-gray" style={{textAlign:"left"}}>{<Translate value="tableopSession.widgets.modifications.modificationEntry.addComment"/>}</Typography>
				}
			</div>
