...
export default class Reset extends Component {
	...
	componentDidMount() {
		authService.verifyReset(this.props.params.token, (err, response) => {
			if (err) {
				console.log(err);
	...
	handleClick = () => {
		...
		authService.resetPassword(this.state.passwordValue, this.props.params.token, (err, response) => {
			if (err) {
				console.log(err);
			}
			else {
	...
	render() {
		...
		return (
			<div className='reset-container'>
				{this.state.verified && !this.state.done &&
					<div>
