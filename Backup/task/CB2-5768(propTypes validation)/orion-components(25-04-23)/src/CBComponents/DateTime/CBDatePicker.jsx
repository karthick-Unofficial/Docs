...
const CBDatePicker = ({
	...
	const actions = [
		clearable && clearLabel ? getTranslation("global.CBComponents.DateTime.clear") : null,
	...
	return (
		<LocalizationProvider dateAdapter={MomentUtils} localeText={localeOverride} adapterLocale={localeOverride}>
			<MobileDatePicker
				{...options}
				id={id}
				label={label}
