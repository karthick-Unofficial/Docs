...
const EntityAddToCollection = ({
	...
	const actions = [
		<Button key="cancel-action-button" className="customActionButton" onClick={handleClose} variant="text">
	...
	return (
		...
		>
			...
			>
				{getTranslation("global.sharedComponents.entityAddToColl.title")}
			</DialogTitle>
			...
			<DialogActions sx={{ flexDirection: "row!important" }} disableSpacing={true}>
				{actions}
			</DialogActions>
		</Dialog>
	);
