...
export const collectionsSelector = createSelector(collectionState, (collections) => {
...
export const makeGetCollection = () => {
	return createSelector(getCollectionById, (collection) => {
		return collection;
	});
};
...
export const makeGetCollectionMembers = () => {
	return createDeepEqualSelector(getCollectionMembers, feedEntitiesSelector, (members, entities) => {
		const fullItems = pickBy(entities, (entity) => members.includes(entity.id));
