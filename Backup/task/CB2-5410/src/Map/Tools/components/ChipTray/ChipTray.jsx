...
const ChipTray = ({ children, buttonCount }) => {
	const offset = useSelector((state) => mapStateSelector(state)?.offset);
	const dockState = useSelector((state) => state.appState.dock.dockData);
