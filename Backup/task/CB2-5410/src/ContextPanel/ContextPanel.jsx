...
import { getGlobalWidgetState } from "orion-components/Profiles/Widgets/Selectors";
...
const ContextPanel = (props) => {
	...
	}, [secondaryOpen, autoExpand, widgetState]);
		...
		<Fragment>
			...
			{children[1] && (
				<div
					...
					className={`${dir && dir == "rtl" ? "secondary-panelRTL" : "secondary-panel"
