		...
		<div style={itemStyles.container}>
			<div
				...
				style={{
					...
					...(isHovered && {
						boxShadow: `0 0 0 3px ${slide.color ? slide.color : "white"}`,
						cursor: "pointer"
					})
				}}
			/>
			...
			{deleteDisabled ? (
				...
				>
					...
					<span>
						<IconButton style={{ padding: 0 }} onClick={() => handleRemoveSlide(index)} disabled={true}>
							<DeleteIcon />
						</IconButton>
					</span>
				</Tooltip>
			) : (
				<IconButton style={{ padding: 0 }} onClick={() => handleRemoveSlide(index)}>
					<DeleteIcon />
				</IconButton>
			)}
		</div>
