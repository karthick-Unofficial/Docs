...
import { getAppId } from "orion-components/Profiles/Selectors";
...
export const eventProfileWidgetConfig = createSelector(
	[getWidgetState, selectIntegrations, getAppId, getTypes, getExternalSystems],
	(widgetState, integrations, appId, types, externalSystems) => (event, widgetsExpandable) => {
		const { type } = event;
