...
render() {
	...
	const actions = [
		<FlatButton
			...
			label={<Translate value="createEditRule.genericAttribute.multiSelection.multiSelectionDialog.addAnother"/>}
			onClick={this.handleCancelClick}
			primary={true}
		/>,
		<FlatButton
			style={styles.buttonStyles}
			label={<Translate value="createEditRule.genericAttribute.multiSelection.multiSelectionDialog.addItem"/>}
			...
			>
				<ErrorBoundary>
					<TypeAheadFilterContainer
						...
						placeholder={this.placeholderConverter("createEditRule.genericAttribute.multiSelection.multiSelectionDialog.wantToFind")}
					/>
				</ErrorBoundary>
