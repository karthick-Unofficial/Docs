...
const FacilitiesWrapper = (props) => {
	const { loadProfile, secondary, feedId, before, filters, replayMap, getInitialPlayBarData } = props;
...
const FacilitiesLayer = memo((props) => {
	...
	const featureData = Object.keys(filteredFacilities).map(facility => {
		...
		feature.properties.mapIcon = mapTools?.feature?.id === facility ? "" : (feature.properties.mapIcon || "Facility_blue");
		return feature;
	});
