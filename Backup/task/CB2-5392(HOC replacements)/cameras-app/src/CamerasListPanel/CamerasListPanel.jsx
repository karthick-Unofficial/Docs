...
import { listPanelState, searchValueSelector, viewingHistorySelector } from "orion-components/ContextPanel/Selectors";
import { collectionsSelector, feedEntitiesByTypeSelector } from "orion-components/GlobalData/Selectors";
import * as accessPointActions from "./AccessPointProfile/accessPointProfileActions";
	...
	const renderProfile = mode => {
		switch (mode) {
			...
			case "accessPoint":
				return (
					<ErrorBoundary>
						<AccessPointProfile {...accessPointActions} facilityOption={true} widgetsExpandable={false} widgetsLaunchable={true} />
					</ErrorBoundary>
				);
