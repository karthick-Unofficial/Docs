		...
		<div>
			{
				<div className={classes.flexContainer} style={{marginBottom: 20}}>
					...
					<div style={{width: 275, marginLeft:-40, marginRight:-15}}> <SearchField value={searchValue} placeholder={placeholderConverter("tableopSession.widgets.events.searchEvents")}
					...
					<div className={classes.flexContainer}>
						<ToggleButton value="blue" aria-label="blue" onClick={handleTeamclick} 
							...
							<div className={classes.contentContainer} style={{cursor:"pointer", marginLeft: 5}}>
								<div className="b1-white" style={{textTransform: "none"}}><Translate value="tableopSession.widgets.events.blueTeam"/></div>
								<div className="b2-bright-gray" style={{textTransform: "none"}}><Translate value="tableopSession.widgets.events.events" count={eventSettingsWithCount["BLUE"]["all"].count}/></div>
							</div>
						</ToggleButton>
						<ToggleButton value="red" aria-label="red" onClick={handleTeamclick}
							...
							<div className={classes.contentContainer} style={{cursor:"pointer", marginLeft: 10}}>
								<div className="b1-white" style={{textTransform: "none"}}><Translate value="tableopSession.widgets.events.blueTeam"/></div>
								<div className="b2-bright-gray" style={{textTransform: "none"}}><Translate value="tableopSession.widgets.events.events" count={eventSettingsWithCount["RED"]["all"].count}/></div>
							</div>
						</ToggleButton>
			...
			</div>
			{
				eventToShare && <T2DialogBox
					open= {openSharing}
					onClose={handleClose}
					headline={<Translate value="tableopSession.widgets.events.shareInfoToTeam"/>}
					submitlabel={<Translate value="tableopSession.widgets.events.notify"/>}
