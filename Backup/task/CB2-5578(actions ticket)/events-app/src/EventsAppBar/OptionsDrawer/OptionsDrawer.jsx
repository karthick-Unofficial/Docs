...
const OptionsDrawer = ({
	...
	const { nauticalChartsEnabled } = size(clientConfig) && clientConfig.mapSettings;
	const { weatherEnabled } = size(clientConfig) && clientConfig.mapSettings;
	...
	return (
		...
		>
			...
			<List>
				...
				>
					<ListItemText
						...
						primaryTypographyProps={{ style: styles.listItemText, className: `option-label ${entityLabelsVisible ? "toggle-on" : "toggle-off"}` }}
					/>
					<Switch
						edge="end"
			...
			<List
				subheader={
					<ListSubheader className="subheader" style={styles.listSubHeader}>
						<Translate value="appBar.optionsDrawer.mapOverlays" /></ListSubheader>
				}>
				...
				>
					<ListItemText
						...
						primaryTypographyProps={{ style: styles.listItemText, className: `option-label ${nauticalChartsVisible ? "toggle-on" : "toggle-off"}` }}
					/>
					<Switch
						edge="end"
				...
				>
					<ListItemText
						...
						primaryTypographyProps={{ style: styles.listItemText, className: `option-label ${roadsVisible ? "toggle-on" : "toggle-off"}` }}
					/>
					<Switch
						edge="end"
				...
				>
					<ListItemText
						...
						primaryTypographyProps={{ style: styles.listItemText, className: `option-label ${weatherVisible ? "toggle-on" : "toggle-off"}` }}
					/>
					<Switch
						edge="end"
