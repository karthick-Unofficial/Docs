...
var _WidgetCard = _interopRequireDefault(require("./WidgetCard"));
...
describe("WidgetCard", function () {
  ...
  it("renders", function () {
    var wrapper = (0, _enzyme.shallow)( /*#__PURE__*/_react["default"].createElement(_WidgetCard["default"], {
      widget: widget,
