...
var AccessPointProfile = function AccessPointProfile(_ref) {
  ...
  var ownerOrg = isLoaded && entity.ownerOrg;
  ...
  var cameraPriority = (0, _reactRedux.useSelector)(function (state) {
    return isLoaded && state.appState.dock.cameraDock.cameraPriority;
  });
