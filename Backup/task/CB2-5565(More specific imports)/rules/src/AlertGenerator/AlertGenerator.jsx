...
const AlertGenerator = () => {
	...
	const alertTypes = useSelector(state => state.clientConfig.alertGeneratorConfig ? state.clientConfig.alertGeneratorConfig.types : defaultConfig.types);
	...
	const myOrgUsers = sortBy(orgUsers, orgUser => {
