	...
	const handleChange = (e) => {
		...
		const minutes =
			timeFormatPreference === "24-hour"
				? value.slice(hoursEndIndex + 1)
				: value.slice(hoursEndIndex + 1, minutesEndIndex);
		...
		switch (e.target.name) {
			case "hours": {
				...
				newString = `${newHours}:${minutes}${
					timeFormatPreference === "24-hour" ? "" : " " + aMPM
				}`;
