		...
		return (
			<div className="generic-attribute">
				...
				<Tabs
					...
					children={[
						<Tab
							label={<Translate value="createEditRule.subject.subjectAttributes.anyTrack"/>}
								...
								>
									...
									{this.props.subject.length > 0 ?
										<ListItem
											...
											primaryText={<Translate value="createEditRule.subject.subjectAttributes.editFeed"/>}
										...
										<ListItem
											className='add-rule-attribute'
											primaryText={<Translate value="createEditRule.subject.subjectAttributes.addFeed"/>}
											onClick={this.handleFeedFilterClick}
											leftIcon={
												<i
													className='material-icons'
						...
						<Tab
							label={<Translate value="createEditRule.subject.subjectAttributes.selectTracks"/>}
							style={styles.tabButton}
							value='a2'
							onActive={this.handleTabClick}
							...
							<div>
								...
								>
									...
									{this.props.subject.length > 0 ?
										<ListItem
											className='add-rule-attribute'
											primaryText={<Translate value="createEditRule.subject.subjectAttributes.addAnother"/>}
										...
										<ListItem
											className='add-rule-attribute'
											primaryText={<Translate value="createEditRule.subject.subjectAttributes.addEntity"/>}
											onClick={this.handleEntityClick}
											leftIcon={
												<i
													className='material-icons'
