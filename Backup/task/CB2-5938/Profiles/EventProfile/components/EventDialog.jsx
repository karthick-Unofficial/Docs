...
const EventDialog = (props) => {
	...
	const [hasManuallyModifiedEndDate, setManuallyModifiedEndDate] = useState(false);
	...
	const handleChange = (name, setState) => (event) => {
		...
		if (name === "endDate") {
			setManuallyModifiedEndDate(!hasManuallyModifiedEndDate);
			setEndTime(new Date());
			setEndDate(value);
		}
		if (name === "endTime") {
				...
				<div>
					{editing && (
						<EventReOpenAndClose
							...
							endDate={endDate}
							onSave={handleSave}
							hasManuallyModifiedEndDate={hasManuallyModifiedEndDate}
						/>
					)}
				</div>
				<div>
