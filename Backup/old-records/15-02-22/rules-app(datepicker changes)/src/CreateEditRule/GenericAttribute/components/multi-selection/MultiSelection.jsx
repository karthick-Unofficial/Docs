		...
		<Fragment>
			<List className='rule-attributes-list'>
				...
				<ListItem
					...
					primaryText={(multiSelectValues && multiSelectValues.length) ? <Translate value="createEditRule.genericAttribute.multiSelection.addAnother"/> : <Translate value="createEditRule.genericAttribute.multiSelection.addDynamic" count={selectionType}/>}
