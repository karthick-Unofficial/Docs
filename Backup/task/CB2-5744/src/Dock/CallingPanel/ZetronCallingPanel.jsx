...
const ZetronCallingPanel = () => {
	...
	const [translatedText] = useState({
		...
		searchError: getTranslation(
			"global.dock.callingPanel.status.searchError"
		),
		searchResults: getTranslation(
			"global.dock.callingPanel.status.results"
		),
	...
	return (
		<div style={zetronStyles.zetronContainer}>
			...
			<div style={zetronStyles.searchBoxLabel}>
			...
			{statusInfo.errorMessage.length > 2 && (
				<div style={zetronStyles.statusInfoErrorMessage}>
				...
				{contactList.map((contact, contactIndex) => {
					return (
						<div
							...
							onMouseEnter={() =>
								setCallButtonVisibleId(contactIndex)
							}
							onMouseLeave={() => setCallButtonVisibleId("")}
						>
							<div style={zetronStyles.resultIconContainer}>
							...
							<div
								style={{
									...
									visibility: `${
										callButtonVisibleId === contactIndex
											? "visible"
											: "hidden"
									}`
								}}
							>
								<Button
									...
									color="primary"
									startIcon={
										<Phone style={zetronStyles.phone} />
									}
									onClick={() =>
										handleInitiateCall(
											contact.isGroup
