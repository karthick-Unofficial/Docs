						...
						<div className="time-condition">
							...
							<div className="date-pickers-wrapper">
								...
								>
									...
									/> */}
									<DatePicker
										className="CBdateStyles"
										style={datePickerStyles}
										value={moment(this.state.startDateValue)._d}
										handleChange={date => this.handleStartDateSelect(timeConversion.convertToUserTime(date, "L"))}
										disabled={this.state.conditionIndefiniteValue}
										dir={dir}
										locale={locale}
										fullWidth={false}
									...
									<DatePicker
										...
										style={datePickerStyles}
										value={moment(this.state.endDateValue)._d}
										handleChange={date => this.handleEndDateSelect(timeConversion.convertToUserTime(date, "L"))}
										disabled={this.state.conditionIndefiniteValue}
										dir={dir}
										locale={locale}
										fullWidth={false}
