...
import { mapObject, disabledFeedsSelector } from "orion-components/AppState/Selectors";
				...
				>
					...
					>
						{userFeeds
							...
							.map((feed) => {
								return (
									<ListItem key={feed.feedId} style={styles.textAlignRight}>
										<ListItemText
											primary={feed.name}
											primaryTypographyProps={{
												style: { fontSize: 16 },
												className: `option-label ${
													!disabledFeeds.includes(feed.feedId) ? "toggle-on" : "toggle-off"
												}`
											}}
										/>
										<Switch
											...
											classes={{
												thumb: !disabledFeeds.includes(feed.feedId)
													? classes.thumbSwitched
													: classes.thumbOff,
												track: !disabledFeeds.includes(feed.feedId)
						...
						<ListItem style={styles.textAlignRight}>
							<ListItemText
								...
								primaryTypographyProps={{
									style: { fontSize: 16 },
									className: `option-label ${
										!disabledFeeds.includes("Event") ? "toggle-on" : "toggle-off"
									}`
								}}
							/>
							<Switch
						...
						<ListItem style={styles.textAlignRight}>
							<ListItemText
								...
								primaryTypographyProps={{
									style: { fontSize: 16 },
									className: `option-label ${
										!disabledFeeds.includes("Point") ? "toggle-on" : "toggle-off"
									}`
								}}
							/>
							<Switch
						...
						<ListItem style={styles.textAlignRight}>
							<ListItemText
								...
								primaryTypographyProps={{
									style: { fontSize: 16 },
									className: `option-label ${
										!disabledFeeds.includes("Polygon") ? "toggle-on" : "toggle-off"
									}`
								}}
							/>
							<Switch
						...
						<ListItem style={styles.textAlignRight}>
							<ListItemText
								...
								primaryTypographyProps={{
									style: { fontSize: 16 },
									className: `option-label ${
										!disabledFeeds.includes("Line") ? "toggle-on" : "toggle-off"
									}`
								}}
							/>
							<Switch
