					...
					{replayFrameValue === "clip-duration" ? (
						...
						<Fragment>
							<div style={{ marginTop: -16, width: 170 }}>
								<DateTimePicker format={"MMMM D, YYYY h:mm A"} handleChange={(time) => setBeginningDate(time)} value={beginningDate} label={getTranslation("newReplay.newTrackReplay.startDate")} okLabel={getTranslation("newReplay.replayArchive.ok")} cancelLabel={getTranslation("newReplay.replayArchive.cancel")} clearLabel={getTranslation("newReplay.replayArchive.clear")}/>
							</div>
							<div style={{ marginTop: -16, width: 170 }}>
								<DateTimePicker minDate={beginningDate} format={"MMMM D, YYYY h:mm A"} handleChange={(time) => setEndDate(time)} value={endDate} label={getTranslation("newReplay.newTrackReplay.endDate")} okLabel={getTranslation("newReplay.replayArchive.ok")} cancelLabel={getTranslation("newReplay.replayArchive.cancel")} clearLabel={getTranslation("newReplay.replayArchive.clear")}/>
							</div>
							<TextField
								id="duration"
