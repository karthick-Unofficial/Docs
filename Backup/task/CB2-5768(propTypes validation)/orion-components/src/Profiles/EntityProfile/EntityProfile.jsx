...
import { closeNotification, addCameraToDockMode, setCameraPriority } from "orion-components/Dock/Actions/index.js";
...
const EntityProfile = ({
	...
	const marineTrafficVisible = useSelector(
		(state) => isLoaded && feedInfoSelector(feedId)(state).marineTrafficVisible
	);
