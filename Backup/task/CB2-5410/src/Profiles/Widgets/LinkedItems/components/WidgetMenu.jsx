...
const WidgetMenu = ({ dir, collapsed, widgetState, widgetName, canLink, linkItems }) => {
	...
	const menuItems = [
		...
		{
			label: "global.profiles.widgets.linkedItems.linkItems",
			onClick: () => {
				linkItems();
			},
			disabled: false,
			showMenuItem: canLink
		}
	];
				...
				<div>
					<Typography fontSize="16px" style={styles.header}>
						<Translate
							...
							count={getTranslation("global.profiles.widgets.linkedItems.title")}
						/>
					</Typography>
