...
const BarrierSelector = React.forwardRef(({ definitionDesc, value, barriers, controlDataTypes, itemSelectionHandler, dir}, ref) => {
	...
	return (
		<div style={{minWidth: 260, marginLeft: 10, marginRight: 10}}>
			<SelectField id="barrierSelect" label={<Translate value="tableopSession.panels.modifications.modificationEditor.barrierSelector.barrier"/>} handleChange={(e)=>handleBarrierChange(e.target.value)}
				formControlProps={{
