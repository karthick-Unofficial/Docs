		...
		<Fragment>
			...
			<CBDialog
				...
				title={getTranslation(
					"global.CBComponents.CBFileLink.dialog.title"
				)}
				textContent={getTranslation(
					"global.CBComponents.CBFileLink.dialog.textContent"
				)}
				confirm={{
					label: getTranslation(
						"global.CBComponents.CBFileLink.dialog.delete"
					),
					action: handleDelete
				}}
				abort={{
					label: getTranslation(
						"global.CBComponents.CBFileLink.dialog.cancel"
					),
