		...
		<Grid container spacing={3}>
			<Grid item lg={2} sm={4} xs={12}>
				<TextField
					...
					label={getTranslation("searchForm.forms.firstName")}
					value={firstName}
					dir={dir}
				/>
			</Grid>
			<Grid item lg={2} sm={4} xs={12}>
				<TextField
					...
					label={getTranslation("searchForm.forms.lastName")}
					value={lastName}
					dir={dir}
				/>
			</Grid>
			<Grid item lg={2} sm={4} xs={12}>
				<TextField
					...
					label={getTranslation("searchForm.forms.dob")}
					value={dOB}
			...
			<Grid item lg={1} sm={2} xs={6}>
				<SelectField
					...
					label={getTranslation("searchForm.forms.sex")}
					value={sex}
					dir={dir}
				>
			...
			<Grid item lg={1} sm={2} xs={6}>
				<SelectField
					...
					label={getTranslation("searchForm.forms.race")}
					value={race}
					dir={dir}
				>
			...
			<Grid item lg={2} sm={4} xs={12}>
				<TextField
					...
					label={getTranslation("searchForm.forms.keyword")}
					value={keyword}
					dir={dir}
				/>
			</Grid>
			<Grid item lg={1} sm={2} xs={6}>
				<Button
					...
					style={{ width: "100%", marginTop: 18, color: "#FFF" }}					
					variant="contained"
				>
