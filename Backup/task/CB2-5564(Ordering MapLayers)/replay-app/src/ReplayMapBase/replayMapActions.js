...
export const toggleMapVisible = () => {
	return {
		type: t.TOGGLE_REPLAY_MAP_VISIBLE
	};
};
...
export const setMapReference = map => {
	return {
		type: t.SET_REPLAY_MAP_REFERENCE,
		payload: { map }
	};
};
...
export const setMapEntities = update => {
	return {
		type: t.SET_REPLAY_MAP_ENTITIES,
		payload: { update }
	};
};
...
export const moveToTarget = (e, geometry, map, movement = "fly") => {
	return (dispatch, getState) => {
		...
		const offset = getState().appState.replayMapRef.offset;
