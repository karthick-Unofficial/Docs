(function (global, factory) {
	if (typeof define === "function" && define.amd) {
		...
		global.CBTimePicker = mod.exports;
	}
	...
	var CBTimePicker = function (_Component) {
		_inherits(CBTimePicker, _Component);

		function CBTimePicker() {
			var _ref;

			var _temp, _this, _ret;

			_classCallCheck(this, CBTimePicker);

			for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
				args[_key] = arguments[_key];
			}

			return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = CBTimePicker.__proto__ || Object.getPrototypeOf(CBTimePicker)).call.apply(_ref, [this].concat(args))), _this), _this.formatDateLabel = function (date, invalidLabel, format) {
				return date === null ? "" : format && date ? _clientAppCore.timeConversion.convertToUserTime(date, format) : invalidLabel;
			}, _temp), _possibleConstructorReturn(_this, _ret);
		}

		_createClass(CBTimePicker, [{
			key: "render",
