...
describe("HiddenEntityDialog", () => {
	it("renders correctly when open", () => {
		const wrapper = shallow(<HiddenEntityDialog open={true} exclusions={[]} />);
		expect(wrapper).toMatchSnapshot();
	});

	it("renders correctly when closed", () => {
		const wrapper = shallow(<HiddenEntityDialog open={false} exclusions={[]} />);
		expect(wrapper).toMatchSnapshot();
	});

	it("renders", () => {
		const wrapper = shallow(<HiddenEntityDialog exclusions={sampleExclusions} />);
		expect(wrapper).toMatchSnapshot();
	});
});
