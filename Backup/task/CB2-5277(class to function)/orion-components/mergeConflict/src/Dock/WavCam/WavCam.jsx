...
const WavCam = ({
	...
	const updateMetadata = function(meta) {
		if(meta) {
			...
			setWavPanoState(stateRef.current.selectedWavCamId, { ...md, ...{ stateRef: stateRef.current } }, showWavCamLabels);
		}
	};
	...
	const setLabelVisibility = function(isVisible) {
		toggleWavCamLabels();
		setWavPanoState(selectedWavCam.id, metadata, isVisible);
	};
		...
		>
			...
			<div style={styles.containerStyle}>
				...
				<div style={dir == "rtl" ? styles.wavCamControlsContainerRTL : styles.wavCamControlsContainer}>
					<div style={dir == "rtl" ? styles.wavCamControlsContainerRTL : styles.wavCamControlsContainer}>
						<IconButton style={{paddingTop: 12 }} onClick={() => toggleWavCam()} >
