...
import { Collapse, Drawer, SvgIcon, IconButton, List, ListItem, Switch, ListItemText, CircularProgress } from "@mui/material";
...
const WavCam = () => {
	...
	const wavCamPersistedState = useSelector(state => state.appState.persisted?.wavcam_pano ?? { wavCamMetadata: {} }, shallowEqual);
	let selectedWavCam = null;
	const context = useSelector(state => wavCams.length > 0 && selectedWavCam ? getContext(selectedWavCam.id)(state) : null, shallowEqual);
	...
	return (
		...
		>
			...
			<div style={styles.containerStyle}>
				...
				<div style={styles.wavImageContainer} ref={wavContainerRef}
