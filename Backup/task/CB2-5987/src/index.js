...
// Create Store
const store = createStore(rootReducer, composeWithDevTools(applyMiddleware(thunk, optimisticAlerts)));
							...
							<ErrorBoundary>
								<Routes>
									...
									>
										...
										<Route path="report-builder/:id" element={<ReportBuilder />} />
										<Route path="download/:fileType/:handle" element={<DownloadReport />} />
									</Route>
								</Routes>
							</ErrorBoundary>
						</HashRouter>
