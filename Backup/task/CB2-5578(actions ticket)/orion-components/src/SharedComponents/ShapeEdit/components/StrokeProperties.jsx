...
const StrokeProperties = ({
	...
	useEffect(() => {
		switch (titleNoun) {
			case "Stroke":
				setThicknessTitle(getTranslation("global.sharedComponents.shapeEdit.strokeProps.strokeThickness"));
				setTypeTitle(getTranslation("global.sharedComponents.shapeEdit.strokeProps.strokeType"));
				break;
			case "Line":
				setThicknessTitle(getTranslation("global.sharedComponents.shapeEdit.strokeProps.lineThickness"));
				setTypeTitle(getTranslation("global.sharedComponents.shapeEdit.strokeProps.lineType"));
				break;
			default:
				...
				<div style={{ width: "45%" }}>
					...
					>
						{thicknessOptions.map(thickVal => (
							<MenuItem key={thickVal} value={thickVal} style={{ fontSize: 14 }} classes={{ selected: classes.selected }}>
				...
				<div style={{ width: "45%" }}>
					...
					>
						{strokeTypeOptions.map(strokeVal => (
							<MenuItem key={strokeVal} value={strokeVal} style={{ fontSize: 14 }} classes={{ selected: classes.selected }}>
