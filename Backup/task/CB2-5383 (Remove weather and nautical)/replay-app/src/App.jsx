...
const propTypes = {
	...
	setFeedPermissions: PropTypes.func.isRequired,
	getGISServices: PropTypes.func.isRequired
};
		...
		<div>
			...
			<ErrorBoundary>
				{location && location.pathname && location.pathname !== "/replay" && !window.api ? (
					<Fragment>
						<ReplayAppBarContainer location={loc} />
						<WavCam />
					</Fragment>
				) : (
					<Fragment>
						<ReplayTopBarContainer location={loc} />
