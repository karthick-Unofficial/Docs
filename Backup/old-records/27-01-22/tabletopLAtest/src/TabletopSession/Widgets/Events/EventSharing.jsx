	...
	return (
		<Container className={ classes.flexContainer} style={{width:700}}>
			...
			<div className={ classes.flexContainer} style={{width:"100%", paddingTop:20, paddingLeft:10, marginTop:30}}>
				{
					!isFacilitator() && 
					<Typography variant="body1" className="b1-bright-gray" style={{marginLeft:10, color:"#b5b9be", display: "inline-block"}}>Choose communication devices and notify team.</Typography>
				}
				{
					isFacilitator() && 
					<div>
						<Typography variant="body1" className="b1-bright-gray" style={{marginLeft:10, color:"#b5b9be", display: "inline-block"}}>Choose players to notify.</Typography>
					...
					isFacilitator() && <TableContainer className={classes.tableContainer}>
						<Table size="small" aria-label="event sharing table">
							<TableHead>
								<TableRow>
									<TableCell> </TableCell>
									<TableCell align="left" width="80" color="#b5b9be"><div style={{color:"#b5b9be"}}>Team</div></TableCell>
									<TableCell align="left" color="#b5b9be"><div style={{color:"#b5b9be"}}>Player</div></TableCell>
			...
			<Container className={classes.dialogActions}>
				<Button style={{ width: 156, marginLeft:10, marginRight:0}} onClick={onClose}>Cancel</Button>
				<Button variant="contained" color="primary" disabled={disabledNotify()} style={{ width: 156, marginLeft:0, marginRight:10 }} onClick={handleNotify}>Notify</Button>
			</Container>
