			...
			switch (cond.type) {
				case "time": {
					...
					if (cond.indefinite) {
						...
						const startDate = timeConversion.convertToUserTime(cond.startDate, "ll");
						const endDate = timeConversion.convertToUserTime(cond.endDate, "ll");
				...
				case "direction": {
					const direction = getTranslation(`global.ruleBuilder.conditionBuilder.direction.${cond.direction}`);
					return getTranslation("global.ruleBuilder.conditionBuilder.heading", direction);
				}
				default:
					break;
			}
