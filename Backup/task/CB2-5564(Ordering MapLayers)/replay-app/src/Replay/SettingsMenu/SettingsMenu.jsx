...
const SettingsMenuWrapper = () => {
	...
	const roadsAndLabels = useSelector(state => state.appState.persisted.mapSettings ? state.appState.persisted.mapSettings["roadsAndLabels"] : null);
	...
	const nauticalCharts = useSelector(state => state.appState.persisted.mapSettings ? state.appState.persisted.mapSettings["nauticalCharts"] : null);
	...
	const entityLabels = useSelector(state => state.appState.persisted.mapSettings ? state.appState.persisted.mapSettings["entityLabels"] : null);
						...
						.map(feed => {
							return (
								<LayerToggle
									...
									customVisibleChange={() => handleLayerToggle(feed.feedId, disabledFeeds, updatePersistedState, setLocalAppState, dispatch)}
								/>
							);
						})}
					<LayerToggle
						...
						customVisibleChange={() => handleLayerToggle("Event", disabledFeeds, updatePersistedState, setLocalAppState, dispatch)}
					/>
					<LayerToggle
						label={getTranslation("replay.settingsMenu.settings.points")}
						updateKey="Point"
						visible={!disabledFeeds.includes("Point")}
						customVisibleChange={() => handleLayerToggle("Point", disabledFeeds, updatePersistedState, setLocalAppState, dispatch)}
					/>
					<LayerToggle
						label={getTranslation("replay.settingsMenu.settings.polygons")}
						updateKey="Polygon"
						visible={!disabledFeeds.includes("Polygon")}
						customVisibleChange={() => handleLayerToggle("Polygon", disabledFeeds, updatePersistedState, setLocalAppState, dispatch)}
					/>
					<LayerToggle
						label={getTranslation("replay.settingsMenu.settings.lines")}
						updateKey="Line"
						visible={!disabledFeeds.includes("Line")}
						customVisibleChange={() => handleLayerToggle("Line", disabledFeeds, updatePersistedState, setLocalAppState, dispatch)}
					/>
				</List>
			</div>
		</Drawer>
