...
const ShapeEdit = ({
	...
	const [displayOnEventActive, setDisplayOnEventActive] = useState(
		app === "events-app" ? true : false
	);
	...
	const handleSaveEvent = () => {
		...
		if (!validateShape(geometry)) {
			setError(
				getTranslation(
					"global.sharedComponents.shapeEdit.errorText.shapesErr"
				)
			);
			return;
		}
	...
	return (
		...
		>
					...
					<div>
						<TextField
							...
							placeholder={getTranslation(
								"global.sharedComponents.shapeEdit.name"
							)}
							required={true}
							variant="filled"
							fullWidth
						...
						<TextField
							...
							placeholder={getTranslation(
								"global.sharedComponents.shapeEdit.description"
							)}
							multiline={true}
							rows={3}
							rowsMax={6}
			...
			<div style={{ overflowY: "scroll" }}>
					...
					<div style={{ marginTop: 4, padding: "0px 20px" }}>
						<SelectField
							...
							label={getTranslation(
								"global.sharedComponents.shapeEdit.mapApp"
							)}
				...
				<Typography
					style={{ padding: "38px 20px 0px 20px" }}
					variant="h6"
				>
					{featureType === "Point" || mode === "draw_point" ? (
					...
					<div style={{ marginTop: -6, padding: "0px 20px" }}>
						<Fragment>
							<SearchField
								...
								value={search}
								placeholder={getTranslation(
									"global.sharedComponents.shapeEdit.searchLib"
								)}
								dir={dir}
							/>
					...
					<Fragment>
						<div style={{ marginTop: 4, padding: "12px 20px" }}>
							<ColorTiles
								...
								title={getTranslation(
									"global.sharedComponents.shapeEdit.fillColor"
								)}
						...
						<div style={{ padding: "17px 20px 0px 20px" }}>
							<ColorTiles
								...
								title={getTranslation(
									"global.sharedComponents.shapeEdit.strokeColor"
								)}
					...
					<Fragment>
						<div style={{ marginTop: 4, padding: "12px 20px" }}>
							<ColorTiles
								selectedColor={strokeColor}
								title={getTranslation(
									"global.sharedComponents.shapeEdit.lineColor"
								)}
								setData={setData("strokeColor")}
							/>
