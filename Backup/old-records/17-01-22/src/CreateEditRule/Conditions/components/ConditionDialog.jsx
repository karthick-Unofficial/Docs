...
class ConditionDialog extends Component {
		...
		if (nextProps.editing) {
			...
			this.setState({
				...
				conditionIndefiniteValue:
					type === "time" ? editingCondition.indefinite : true,
				conditionAnyTimeValue:
					type === "time" ? editingCondition.anyTimeOfDay : true,
	...
	render() {
		const { editing, conditions, isOpen, landUnitSystem, timeFormatPreference } = this.props;
		const { speedUnit } = this.state;
		...
		return (
			<Dialog
				...
				title={<Translate value="createEditRule.conditions.conditionDialog.addCondition"/>}
			...
			>
				<div className="condition-dialog">
					<SelectField
						...
						hintStyle={{ color: "#828283", marginLeft: "24px" }}
