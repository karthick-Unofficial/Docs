	...
	return (
		<Container className={ classes.flexContainer} style={{width:isFacilitator()? 632: 722, marginLeft:-20}}>
			<div className={ classes.flexContainerHorizontalStart}>
				...
				<div style={{marginLeft:0}}>
					<Typography variant="body1" className="b1-bright-gray" style={{marginLeft:10, marginTop: 5, color:"#b5b9be", height:16}}>
						{`Choose observed weapons and equipment for ${agentInfo.entityData.properties.displayName|| agentInfo.entityData.properties.name}`}</Typography>
				</div>
			</div>
			...
			<div className={ classes.flexContainer} style={{width:"100%", paddingTop:20, paddingLeft:10, marginTop:0}}>
				{
					!isFacilitator() && 
					<Typography variant="body1" className="b1-bright-gray" style={{marginLeft:10, color:"#b5b9be"}}>Choose communication devices and notify team.</Typography>
				}
				{
					isFacilitator() && <Typography variant="body1" className="b1-bright-gray" style={{marginLeft:10, color:"#b5b9be"}}>Choose players to notify.</Typography>
				}
							...
							<Table size="small" aria-label="a dense table">
								<TableHead>
									<TableRow>
										...
										<TableCell align="left" width="80" ><div style={{color:"#b5b9be"}}>Team</div></TableCell>
										<TableCell align="left"><div style={{color:"#b5b9be"}}>Player</div></TableCell>
										<TableCell align="left"><div style={{color:"#b5b9be"}}>Time</div></TableCell>
									</TableRow>
								</TableHead>
								<TableBody>
										...
										return (<TableRow key={`tr ${agnt.id}`}>
											...
											<TableCell align="left" className="viewTimeLink">
												{lastCommunicatedTime != null &&
													<div>
														<a className="viewTimes" style={{color: "#4db5f4", cursor: "pointer"}} onClick={(event) => handleToggleFacilitator(event, agnt.id)}>View Times</a>
						...
						<TableContainer className={classes.tableContainer}>
							<Table size="small" aria-label="comm sharing table">
								<TableHead>
									<TableRow>
										<TableCell> </TableCell>
										<TableCell align="left"><div style={{color:"#b5b9be"}}>Comm&nbsp;Device</div></TableCell>
										<TableCell align="left"><div style={{color:"#b5b9be", width:150}}>Owner</div></TableCell>
										<TableCell align="left"><div style={{color:"#b5b9be"}}>Recipients</div></TableCell>
										<TableCell align="left"><div style={{color:"#b5b9be"}}>Time</div></TableCell>
									</TableRow>
								</TableHead>
								<TableBody>
									{ownerCommDevices.map(comm => {
										...
										return (<TableRow key={`tr ${comm.id}`}>
											...
											<TableCell align="left">{
												<div style={{color: "#414449"}}>
													<List key={comm.id} component="nav" aria-label={"View recipients"}>
														...
														>
															<ListItemText primary={<span style={{color:"#4DB5F4", marginLeft:-12}}>View Recipients</span>}/>
											...
											<TableCell align="left" className="viewTimeLink">
												{lastCommunicatedTime != null &&
													<div>
														<a className="viewTimes" style={{color: "#4db5f4", cursor: "pointer"}} onClick={(event) => handleToggleNonFacilitator(event, comm.id)}>View Times</a>
			...
			<Container className={classes.dialogActions}>
				<Button style={{ width: 74, height:41, marginLeft:10, marginRight:20}} onClick={onClose}>Cancel</Button>
				<Button variant="contained" color="primary" disabled={disabledNotify()} style={{ width: 74, height:41, marginLeft:0, marginRight:10 }} onClick={handleNotify}>Notify</Button>
			</Container>
