...
import { List, ListItem, Avatar, Divider, SvgIcon, Tooltip } from "@mui/material";
//import { SocialPerson, AlertError } from "@mui/icons-material";
						...
						<Fragment key={`adUser-${index}`}>
							<ListItem
								...
								leftAvatar={<Avatar icon={
									<Person color={"#FFF"} />}
									backgroundColor={"#1f1f21"} color={"white"} />}
