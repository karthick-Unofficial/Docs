		...
		<div style={{width:"100%"}}>
			...
			<div className={classes.flexContainer}>
				<div className={classes.flexContentHorizontal}>
					...
					<LayerIcon timeline labelText={<Translate value="tableopSession.widgets.mapLayers.timelineControl"/>}/>
				</div>
				<div className={classes.flexContentHorizontal}>
					...
					<LayerIcon floorPlan labelText={<Translate value="tableopSession.widgets.mapLayers.floorPlanControl"/>}/>
				</div>
			</div>
