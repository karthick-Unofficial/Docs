...
const CreateEvent = ({
	...
	const templateOptions = [{value: null, label: "None"}];
	...
	const typeOptions = [{value: null, label: "None"}], subtypeOptions = [{value: null, label: "None"}];
									...
									<div className="rule-attribute-col">
										<div className="rule-attribute-row">
											<ErrorBoundary>
												<GenericAttribute
													type={"Template"}
													description={"Choose an event template to monitor."}
													inputType={"dropdown"}
										...
										<div className="rule-attribute-row">
											<ErrorBoundary>
												<GenericAttribute
													type={"Type"}
													description={"Choose an event type to monitor."}
													inputType={"dropdown"}
										...
										<div className={"rule-attribute-row last-row" + (disableSubtype && " disabled")}>
											<ErrorBoundary>
												<GenericAttribute
													type={"Subtype"}
													description={"Choose an event subtype to monitor."}
													inputType={"dropdown"}
