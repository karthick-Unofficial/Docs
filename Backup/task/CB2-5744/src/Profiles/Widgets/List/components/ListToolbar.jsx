	...
	if (props.editableRow)
		return (
			<Button variant="text" color="primary" onClick={props.cancelAddRow}>
				{getTranslation(
					"global.profiles.widgets.list.listToolbar.cancel"
				)}
			</Button>
		);
		...
		return (
			<React.Fragment>
				...
				>
					{getTranslation(
						"global.profiles.widgets.list.listToolbar.save"
					)}
				</Button>
				<Button
		...
		return (
			<React.Fragment>
				...
				>
					{getTranslation(
						"global.profiles.widgets.list.listToolbar.add"
					)}
				</Button>
				<Button
					style={{ width: "70%", minWidth: 0 }}
				...
				>
					{getTranslation(
						"global.profiles.widgets.list.listToolbar.remove"
					)}
				</Button>
			</React.Fragment>
		);
