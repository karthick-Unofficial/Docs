...
const AssignmentForm = ({ handleClose }) => {
	...
	const styles = {
		...
		circularProgressWrapper: {
			...(dir === "rtl" ? { marginRight: "60px" } : { marginLeft: "60px" })
		},
		deleteBtn: {
			color: deletionConfirm ? "#FFF" : "#E85858",
			...(dir === "rtl" ? { marginLeft: "64px" } : { marginRight: "64px" })
		},
		deleteBtnWrapper: {
			...(dir === "rtl" ? { marginRight: "auto" } : { marginLeft: "auto" })
		},
		checkCircle: {
			...(dir === "rtl" ? { marginLeft: 12 } : { marginRight: 12 })
		}
	};
